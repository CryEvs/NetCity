var language = {
  "Generic": {
    ...
    "Calendar": {
      ...
      "kResults": "оценки",
      "kRole": "Роль",
      "kRoomNormNotFit": "нормативная наполняемость не соответствует рекомендуемой",
    ...
    "ClassManagement": {
      ...
      "kDefineAddSchoolEducProgramsW": "Невозможно добавить объединение, т.к. в организации не определены программы обучения со статусом \"Активная программа\".",
      "kDelClass": "Удалить ",
    ...
    "Common": {
      ...
      "kContentElementCodes": "Коды элементов содержания",
      "kContinue": "Продолжить?",
    ...
    "Curriculum": {
      ...
      "kNoSubjectsInYear_All": "Для данного учебного года в учебном плане нет предметов",
      "kNotes": "Примечания",
      ...
      "kTitleCopyUnit": "Копировать раздел",
    ...
    "Messages": {
      ...
      "kOriginalMessageText": "Исходный текст сообщения",
      ...
      "kWhom": "Кому",
      "kYourDraftWasSaved": "Ваш черновик сохранён. Чтобы отправить это сообщение, используйте кнопку \"Отправить.\"",
    ...
    "ResourceGroups": {
      ...
      "kCreateDoc": "Создать новый документ",
      "kCreateGroup": "Создать новый раздел",
      "kCreateLink": "Создать новую ссылку",
    ...
    "ServAdmin": {
      ...
      "kVkAppId": "Идентификатор приложения ВК",
