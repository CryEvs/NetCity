...
UserStatEMCtrl = (function() {
  ...
  function UserStatEMCtrl(container, filterPanel) {
    ...
    queries = [
      loadTemplate('/static/dist/pages/userstat/userStatEmAdmTemplate.html', function(html) {
        return userStatEmAdmInfoTmpl = html;
      }, loadTemplate('/static/dist/pages/userstat/userStatEmEoTemplate.html', function(html) {
        return userStatEmEoInfoTmpl = html;
      }, loadTemplate('/static/dist/pages/userstat/userStatEmEoOneTemplate.html', function(html) {
        return userStatEmEoOneInfoTmpl = html;
      }, loadTemplate('/static/dist/pages/userstat/userStatEmEmTemplate.html', function(html) {
