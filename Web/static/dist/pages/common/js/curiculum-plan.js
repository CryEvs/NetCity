...
curiculumPlanCtrl = (function() {
  ...
  curiculumPlanCtrl.prototype.clearPlan = function() {
    ...
    $("tr.total-fact-load-row").find("td:not(:first)").html("");
    $("tr.component-fact-load-row").find("td:not(:first)").html("");
    $("tr.total-teacher-load-row ").find("td:not(:first)").html("");
    $("td.waschanged").removeClass("waschanged");
