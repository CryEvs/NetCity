'use strict';
angular.module('netcity.em.indicators', ["netcity.indicators.controllers", "netcity.indicators.directives", "netcity.helpers", "netcity.validation", "netcity.resources", "uikit.dialogs", "uikit.alerts"]).run(function($http) {
