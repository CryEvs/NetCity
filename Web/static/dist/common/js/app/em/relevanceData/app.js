'use strict';
angular.module('netcity.em.indicators', ["netcity.indicators.controllers", "netcity.helpers", "netcity.validation", "netcity.resources", "uikit.dialogs", "uikit.alerts"]).run(function($http) {
  $http.defaults.withCredentials = true;
  $http.defaults.headers.common['at'] = strATTok;
});

angular.module('netcity.resources').factory('relevanceDataRepository', function(indicatorsRepository) {
  var baseRep;
