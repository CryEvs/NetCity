...
var _reportlist = __webpack_require__(473);
var _module = angular.module("irtech.netcity.school.reports", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "irtech.netcity.common", "ngFileUpload", "ui.tree", "irtech.netcity.ui-components"]);
/*@ngInject*/
var config = function config($routeProvider, $locationProvider) {
  $routeProvider.when("/list/", _reportlist.ReportListComponent).when("/:reportId", _report.ReportComponent).otherwise(_reportlist.ReportListComponent);
