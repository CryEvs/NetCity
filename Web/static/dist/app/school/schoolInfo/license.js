...
LicenseController.addLicenseListEmptyInfo = function () {
  var info = $('<div class="col-md-6 license-list-empty"></div>').append($("<div></div>").addClass("alert alert-info").text(language.Generic.SchoolInfo.kDocumentListEmpty));
...
LicenseController.loadPage = function () {
  ...
  var getLicenseList = jsSubmit({
    method: "GET",
    action: "/webapi/schools/".concat(LicenseController.schoolId, "/licenses")
  });
  LicenseController.when(LicenseController.getLicenseTemplate(), getLicenseList).then(function (licenseTemplate, list) {
    ...
    if (!LicenseController.hasAnyLicense(LicenseController.licenseContainer)) {
      ...
      LicenseController.drawLicenses(licenseTemplate);
    }
...
LicenseController.drawLicenses = function (licenseTemplate) {
  var html = licenseTemplate({
    licenseAttachment: LicenseController.licenseAttachment,
    licenseAesAttachment: LicenseController.licenseAesAttachment,
    licenseAccredAttachment: LicenseController.licenseAccredAttachment,
...
LicenseController.addLicense = function () {
  ...
  var file = LicenseController.fileAttachControllerLicense.fileAttachments.files[0];
  if (file) {
    fileAttachment = LicenseController.getFileAttachmentDto(file);
  }
  var licenseDto = {
    seriesBlank: seria,
    numberBlank: number,
  ...
  LicenseController.when(LicenseController.getLicenseTemplate(), jsSubmit({
    method: "POST",
    action: "/webapi/schools/".concat(LicenseController.schoolId, "/addLicense"),
    data: licenseDto,
...
LicenseController.addLicenseAES = function () {
  ...
  var file = LicenseController.fileAttachControllerLicenseAES.fileAttachments.files[0];
  if (file) {
    fileAttachment = LicenseController.getFileAttachmentDto(file);
  }
  var licenseDto = {
  ...
  LicenseController.when(LicenseController.getLicenseTemplate(), jsSubmit({
    method: "POST",
    action: "/webapi/schools/".concat(LicenseController.schoolId, "/addLicenseAES"),
    data: licenseDto,
    contentType: "application/json"
  })).then(function (template) {
    template = Handlebars.compile(template);
...
LicenseController.addAccreditation = function () {
  ...
  var file = LicenseController.fileAttachControllerAccreditation.fileAttachments.files[0];
  if (file) {
    fileAttachment = LicenseController.getFileAttachmentDto(file);
  }
  var licenseDto = {
  ...
  LicenseController.when(LicenseController.getLicenseTemplate(), jsSubmit({
    method: "POST",
    action: "/webapi/schools/".concat(LicenseController.schoolId, "/addAccreditation"),
    data: licenseDto,
    contentType: "application/json"
  })).then(function (template) {
    template = Handlebars.compile(template);
...
LicenseController.removeLicense = function () {
  $.show.confirmation(language.Generic.SchoolInfo.kAreSureDeleteDocument).then(function () {
    jsSubmit({
      method: "DELETE",
      action: "/webapi/schools/".concat(LicenseController.schoolId, "/deleteLicense/"),
      showProcessing: true,
...
LicenseController.removeLicenseAES = function () {
  $.show.confirmation(language.Generic.SchoolInfo.kAreSureDeleteDocument).then(function () {
    jsSubmit({
      method: "DELETE",
      action: "/webapi/schools/".concat(LicenseController.schoolId, "/deleteLicensesAES/"),
      showProcessing: true,
      onSuccess: function onSuccess() {
...
LicenseController.removeAccreditation = function () {
  $.show.confirmation(language.Generic.SchoolInfo.kAreSureDeleteDocument).then(function () {
    jsSubmit({
      method: "DELETE",
      action: "/webapi/schools/".concat(LicenseController.schoolId, "/deleteAccreditation/"),
      showProcessing: true,
      onSuccess: function onSuccess() {
...
LicenseController.hasAnyLicense = function (licenseContainer) {
  if (licenseContainer.license || licenseContainer.licenseAES || licenseContainer.accreditation) return true;
  return false;
};
...
LicenseController.editLicense = function () {
  ...
  var edit = function edit(dialog) {
    ...
    LicenseController.when(LicenseController.getLicenseTemplate(), jsSubmit({
      method: "PUT",
      action: "/webapi/schools/".concat(LicenseController.schoolId, "/editLicense"),
      data: licenseDto,
      contentType: "application/json"
    })).then(function (template) {
      template = Handlebars.compile(template);
  ...
  LicenseController.getEditLicenseTemplate().then(function (template) {
    ...
    $.show.dialog({
      ...
      onshown: function onshown() {
        ...
        $('select[name="licenseType"]').append(option).prop("disabled", true);
        dateInput.initDateInputs(null, null, null, {
          format: "d.mm.yyyy"
        });
        form = $('form[name="add-license"]');
...
LicenseController.editLicenseAES = function () {
  ...
  var edit = function edit(dialog) {
    ...
    LicenseController.when(LicenseController.getLicenseTemplate(), jsSubmit({
      method: "PUT",
      action: "/webapi/schools/".concat(LicenseController.schoolId, "/editLicenseAES"),
      data: licenseDto,
      contentType: "application/json"
    })).then(function (template) {
      template = Handlebars.compile(template);
...
LicenseController.editAccreditation = function () {
  ...
  var edit = function edit(dialog) {
    ...
    LicenseController.when(LicenseController.getLicenseTemplate(), jsSubmit({
      method: "PUT",
      action: "/webapi/schools/".concat(LicenseController.schoolId, "/editAccreditation"),
      data: licenseDto,
      contentType: "application/json"
    })).then(function (template) {
      template = Handlebars.compile(template);
...
LicenseController.getFileAttachmentDto = function (file) {
  return {
    id: file.Id,
