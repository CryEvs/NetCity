...
var _searchStudentCtrl = __webpack_require__(250);
var _fileattachments = __webpack_require__(251);
var _common = __webpack_require__(252);
var _certifSettings = __webpack_require__(334);
var _educCertifsRegistry = __webpack_require__(335);
var _module = angular.module("irtech.netcity.em.educcertificates", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "ngFileUpload", "ui.tree", "irtech.netcity.common", "irtech.netcity.ui-components"]);
...
_module.factory("certifRepository", function ($http, $dialogs, $alerts) {
...
}).factory("searchStudentService", function ($uibModal) {
  return new _searchStudentCtrl.SearchStudentService($uibModal);
}).service("fileUploadService", _fileattachments.FileUploadService).service("downloadService", _common.DownloadService).service("certifSettingsRepository", _certifSettings.CertificateSettingsRepository).directive("nsDateModel", function (dateUtils) {
  var toStr = function toStr(dateParam) {
    return dateParam ? dateUtils.date2str(new Date(dateParam)) : null;
  };
  return {
  ...
  $routeProvider.when("/registry/", _educCertifsRegistry.EducCertifiactesRegistryComponent).otherwise(_educCertifsRegistry.EducCertifiactesRegistryComponent);
...
exports.SearchStudentService = exports.SearchCertifStudent = exports.SeachStudentController = void 0;
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var SearchCertifStudent = /*#__PURE__*/_createClass(function SearchCertifStudent() {
  _classCallCheck(this, SearchCertifStudent);
  this.students = [];
  this.studentsExternal = [];
});
exports.SearchCertifStudent = SearchCertifStudent;
var SeachStudentController = /*#__PURE__*/function () {
  function SeachStudentController($uibModalInstance, $http, $longWork, $dialogs, isIntegrationSlavinAndPoo) {
    _classCallCheck(this, SeachStudentController);
    this.$http = $http;
    this.language = language;
    this.$uibModalInstance = $uibModalInstance;
    this.$longWork = $longWork;
    this.$dialogs = $dialogs;
    this.title = "Поиск учащегося";
    this.students = new SearchCertifStudent();
    ...
    this.isIntegrationSlavinAndPoo = isIntegrationSlavinAndPoo;
    this.isEmptyStudents = true;
    this.isEmptyStudentsExternal = true;
  }
  _createClass(SeachStudentController, [{
    key: "search",
    value: function search() {
      var _this = this;
      if (!this.$longWork.isShowing) this.$longWork.show();
      this.$http.get("/webapi/educcertificates/searchstudent", {
        params: this.searchData
      }).then(function (response) {
        _this.selection.dropSelect();
        _this.searchCompleted = true;
        _this.students = response.data;
        _this.isEmptyStudents = _this.students.students.length === 0;
        _this.isEmptyStudentsExternal = _this.students.studentsExternal.length === 0;
        if (!_this.isEmptyStudents) {
          _this.selection.select(_this.students.students[0]);
        } else if (!_this.isEmptyStudentsExternal) {
          _this.selection.select(_this.students.studentsExternal[0]);
        }
      })["catch"](function (ex) {
        return _this.$dialogs.error("Ошибка обращения к сервису модуля ПОО.\n" + ex.data.message);
      })["finally"](function () {
        return _this.$longWork.close();
      });
    }
  }, {
    key: "select",
    ...
    value: function isValidForm() {
      var middlename = this.searchData.noMiddlename ? true : this.searchData.middlename;
      var isFioFill = this.searchData.lastname && this.searchData.firstname && middlename && true;
      return isFioFill;
    }
  }]);
  return SeachStudentController;
}();
exports.SeachStudentController = SeachStudentController;
var SearchStudentService = /*#__PURE__*/function () {
  function SearchStudentService($uibModal) {
    _classCallCheck(this, SearchStudentService);
    this.$uibModal = $uibModal;
  }
  _createClass(SearchStudentService, [{
    key: "search",
    value: function search(_isIntegrationSlavinAndPoo) {
      var modalInstance = this.$uibModal.open({
        templateUrl: "/static/dist/app/em/educcertificates/edit/searchStudent.html",
        controller: SeachStudentController,
        controllerAs: "searchCtrl",
        size: "lg",
        resolve: {
          isIntegrationSlavinAndPoo: function isIntegrationSlavinAndPoo() {
            return _isIntegrationSlavinAndPoo;
          }
        }
      });
      return modalInstance.result.then(function (student) {
        return student;
      });
    }
  }]);
...
var _changeTracker = __webpack_require__(259);
var _contextService = __webpack_require__(260);
var _settingsProvider = __webpack_require__(234);
var _context = __webpack_require__(261);
var _printExport = __webpack_require__(262);
var _apploader = __webpack_require__(263);
var _logging = __webpack_require__(264);
var _downloadFile2 = __webpack_require__(102);
var _exceptionHandler = __webpack_require__(265);
var _common = __webpack_require__(123);
var _common2 = __webpack_require__(266);
var _netcityModalCtrl = __webpack_require__(36);
var _netcityController = __webpack_require__(267);
var _filterpanel = __webpack_require__(268);
var _baseRepository = __webpack_require__(41);
var _inputSuggest = __webpack_require__(277);
var _registry = __webpack_require__(278);
var _registry2 = __webpack_require__(279);
var _fileattachments = __webpack_require__(251);
var _nsPanel = __webpack_require__(283);
var _nsModal = __webpack_require__(50);
var _nsForm = __webpack_require__(284);
var _taskqueue = __webpack_require__(285);
var _common3 = __webpack_require__(3);
__webpack_require__(290);
__webpack_require__(291);
__webpack_require__(11);
var _uikit2 = __webpack_require__(292);
var _tree = __webpack_require__(293);
var _select = __webpack_require__(295);
__webpack_require__(296);
__webpack_require__(297);
__webpack_require__(298);
var _dateInput = __webpack_require__(299);
var _common4 = __webpack_require__(300);
var _dateUtils = __webpack_require__(301);
var _earlyaccess = __webpack_require__(302);
__webpack_require__(303);
var _schoolCard = __webpack_require__(304);
var _listOnlineUsers = __webpack_require__(306);
var _sessions = __webpack_require__(308);
var _switchYear = __webpack_require__(309);
var _appBackgroundTask = __webpack_require__(310);
var _appMailButton = __webpack_require__(311);
var _appForumButton = __webpack_require__(312);
var _appHelpButton = __webpack_require__(313);
var _appAnnouncementsButton = __webpack_require__(314);
var _coworker = __webpack_require__(315);
var _orginfo = __webpack_require__(317);
var _changepassword = __webpack_require__(318);
var _app2 = __webpack_require__(255);
var _commonChangepassword = __webpack_require__(319);
var _commonChangepassword2 = __webpack_require__(320);
var _changepassword2 = __webpack_require__(322);
var _ssoLink = __webpack_require__(324);
var _ssoLink2 = __webpack_require__(325);
var _parentstudentslist = __webpack_require__(326);
var _parentstudentslist2 = __webpack_require__(327);
var _metrika = __webpack_require__(328);
var _metrika2 = __webpack_require__(329);
var _sferumBanner = __webpack_require__(330);
var _userSettings = __webpack_require__(185);
var _appChatsButton = __webpack_require__(332);
...
var _rooms = __webpack_require__(254);
...
var _resourceLoader = __webpack_require__(256);
var _common = __webpack_require__(8);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var _common = __webpack_require__(258);
var _commonLegacy = __webpack_require__(103);
var _urlHelper = __webpack_require__(4);
var _app = __webpack_require__(255);
...
var _filterpanel = __webpack_require__(269);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var _datetange = __webpack_require__(272);
var _date = __webpack_require__(273);
var _baseRepository = __webpack_require__(41);
var _listrange = __webpack_require__(274);
var _checks = __webpack_require__(275);
var _text = __webpack_require__(276);
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var _filter = __webpack_require__(271);
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var _registry = __webpack_require__(279);
...
var _registry2 = __webpack_require__(280);
var _registrySelected = __webpack_require__(281);
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var _registrySelected = __webpack_require__(282);
...
var _taskqueue = __webpack_require__(287);
var _common = __webpack_require__(31);
var _taskexecution = __webpack_require__(288);
var _queuehub = __webpack_require__(289);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _get() { if (typeof Reflect !== "undefined" && Reflect.get) { _get = Reflect.get.bind(); } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(arguments.length < 3 ? target : receiver); } return desc.value; }; } return _get.apply(this, arguments); }
function _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) _setPrototypeOf(subClass, superClass); }
...
var _schoolCard = __webpack_require__(305);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var _listOnlineUsers = __webpack_require__(307);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var _baseRepository = __webpack_require__(41);
var _coworker = __webpack_require__(316);
...
var _changepassword = __webpack_require__(321);
var _common = __webpack_require__(31);
...
var _modalChangepassword = __webpack_require__(323);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var _common = __webpack_require__(3);
var _ssoLink = __webpack_require__(325);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var _securityrights = __webpack_require__(154);
var _common = __webpack_require__(105);
var _metrika = __webpack_require__(328);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var _commonRouting = __webpack_require__(331);
var _common = __webpack_require__(105);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var _settingsProvider = __webpack_require__(234);
var _certifSettings = __webpack_require__(336);
var _downloadBlanks = __webpack_require__(337);
var _editEducCertificate = __webpack_require__(338);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var EducCertifiactesRegistryController = /*#__PURE__*/function () {
  EducCertifiactesRegistryController.$inject = ["pageContext", "certifRepository", "$uibModal", "dateUtils", "appContext", "settingsProvider", "language", "searchStudentService"];
  /*@ngInject*/
  function EducCertifiactesRegistryController(pageContext, certifRepository, $uibModal, dateUtils, appContext, settingsProvider, language, searchStudentService) {
  ...
  _createClass(EducCertifiactesRegistryController, [{
    ...
    value: function init() {
      ...
      //кнопка поиск сертификатов
      var searchCertifButton = {
        title: 'Поиск сертификата',
        icon: "glyphicon glyphicon-search",
        action: function action() {
          _this.$uibModal.open({
            templateUrl: "/static/dist/app/em/educcertificates/edit/searchEducCertifs.html",
            controller: 'SearchEducCertifCtrl as searchCtrl',
            size: "lg"
          });
        }
      };
      //кнопка настройки сертификатов
      var settingsCertifButton = {
        title: 'Настройки',
        icon: "glyphicon glyphicon-cog",
        action: function action() {
          return _this.$uibModal.open({
            controller: _certifSettings.CertificateSettingsComponent.controller,
            controllerAs: _certifSettings.CertificateSettingsComponent.controllerAs,
            templateUrl: _certifSettings.CertificateSettingsComponent.templateUrl,
            size: "lg"
          });
        }
      };
      this.registryInfo = {
        url: "/webapi/em/educcertificates/registry",
        filtersUrl: "/webapi/em/educcertificates/registry/filter",
        fieldDecorators: {
        ...
        buttons: [searchCertifButton],
        linkButtons: []
      };
      if (this.appContext.hlevel !== 1) {
        //УО смешенного уровня - не должно иметь прав на создание
        this.registryInfo.buttons.push(addCertifButton);
      }
      this.settingsProvider.ServerSettings.SystemSettings.IntegrationPFDOType().then(function (pfdoType) {
        ...
        if (pfdoType == _settingsProvider.PfdoIntegrationType.Slavin) {
          ...
          if (!_this.appContext.isTopEm) {
            //Настройки сертификатов доступны для УО муниципального уровня
            _this.registryInfo.buttons.push(settingsCertifButton);
          }
        }
      });
      this.settingsProvider.ServerSettings.SystemSettings.ModulePoo().then(function (responce) {
        return _this.ModulePoo = responce;
      });
      this.settingsProvider.ServerSettings.SystemSettings.EditCertificatesDOOnlyByRegion().then(function (onlyByRegion) {
        if (onlyByRegion && !_this.appContext.isTopEm) {
          // cantEditCertif
          //$scope.fieldDecorators["number"] = null; // #29388, post 9
          _this.editState.editOnlyStatus = true;
        }
      });
    }
  }, {
    ...
    value: function add() {
      var _this2 = this;
      var defaultCertifStatus;
      this.isIntegrationSlavinAndPoo = this.pfdoType == _settingsProvider.PfdoIntegrationType.Slavin && this.ModulePoo;
      this.certifRepository.getAddCertifStatuses().then(function (resp) {
        return defaultCertifStatus = resp.find(function (x) {
          return x.id == 1;
        });
      }).then(function () {
        return _this2.searchStudentService.search(_this2.isIntegrationSlavinAndPoo);
      }).then(function (student) {
        var certifInfo = {
          systemExternalId: student.systemId,
          systemInstanceId: student.systemInstanceId,
          ...
          endDate: moment(student.studentBirthDate).add(18, "years").startOf("day").toDate(),
          status: defaultCertifStatus,
          studentBirthDate: student.studentBirthDate,
          emId: _this2.appContext.emId,
          identityDocumentInfo: student.identityDocumentInfo,
    ...
    value: function edit(certif) {
      var _this3 = this;
      this.certifRepository.get(certif.id).then(function (certifInfo) {
        var modalInstance = _this3.$uibModal.open({
          ...
          resolve: {
            ...
            editState: function editState() {
              return angular.copy(_this3.editState);
            }
          }
        });
        modalInstance.rendered.then(function () {
          dateInput.initDateInputs(null, null, null, {
            format: _this3.dateUtils.getDateFormat().format
          });
        });
        modalInstance.result.then(function () {
...
exports.CertificateSettingsComponent = void 0;
__webpack_require__(303);
var _netcityModalCtrl = __webpack_require__(36);
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return exports; }; var exports = {}, Op = Object.prototype, hasOwn = Op.hasOwnProperty, defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; }, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag"; function define(obj, key, value) { return Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }), obj[key]; } try { define({}, ""); } catch (err) { define = function define(obj, key, value) { return obj[key] = value; }; } function wrap(innerFn, outerFn, self, tryLocsList) { var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator, generator = Object.create(protoGenerator.prototype), context = new Context(tryLocsList || []); return defineProperty(generator, "_invoke", { value: makeInvokeMethod(innerFn, self, context) }), generator; } function tryCatch(fn, obj, arg) { try { return { type: "normal", arg: fn.call(obj, arg) }; } catch (err) { return { type: "throw", arg: err }; } } exports.wrap = wrap; var ContinueSentinel = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var IteratorPrototype = {}; define(IteratorPrototype, iteratorSymbol, function () { return this; }); var getProto = Object.getPrototypeOf, NativeIteratorPrototype = getProto && getProto(getProto(values([]))); NativeIteratorPrototype && NativeIteratorPrototype !== Op && hasOwn.call(NativeIteratorPrototype, iteratorSymbol) && (IteratorPrototype = NativeIteratorPrototype); var Gp = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(IteratorPrototype); function defineIteratorMethods(prototype) { ["next", "throw", "return"].forEach(function (method) { define(prototype, method, function (arg) { return this._invoke(method, arg); }); }); } function AsyncIterator(generator, PromiseImpl) { function invoke(method, arg, resolve, reject) { var record = tryCatch(generator[method], generator, arg); if ("throw" !== record.type) { var result = record.arg, value = result.value; return value && "object" == _typeof(value) && hasOwn.call(value, "__await") ? PromiseImpl.resolve(value.__await).then(function (value) { invoke("next", value, resolve, reject); }, function (err) { invoke("throw", err, resolve, reject); }) : PromiseImpl.resolve(value).then(function (unwrapped) { result.value = unwrapped, resolve(result); }, function (error) { return invoke("throw", error, resolve, reject); }); } reject(record.arg); } var previousPromise; defineProperty(this, "_invoke", { value: function value(method, arg) { function callInvokeWithMethodAndArg() { return new PromiseImpl(function (resolve, reject) { invoke(method, arg, resolve, reject); }); } return previousPromise = previousPromise ? previousPromise.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(innerFn, self, context) { var state = "suspendedStart"; return function (method, arg) { if ("executing" === state) throw new Error("Generator is already running"); if ("completed" === state) { if ("throw" === method) throw arg; return doneResult(); } for (context.method = method, context.arg = arg;;) { var delegate = context.delegate; if (delegate) { var delegateResult = maybeInvokeDelegate(delegate, context); if (delegateResult) { if (delegateResult === ContinueSentinel) continue; return delegateResult; } } if ("next" === context.method) context.sent = context._sent = context.arg;else if ("throw" === context.method) { if ("suspendedStart" === state) throw state = "completed", context.arg; context.dispatchException(context.arg); } else "return" === context.method && context.abrupt("return", context.arg); state = "executing"; var record = tryCatch(innerFn, self, context); if ("normal" === record.type) { if (state = context.done ? "completed" : "suspendedYield", record.arg === ContinueSentinel) continue; return { value: record.arg, done: context.done }; } "throw" === record.type && (state = "completed", context.method = "throw", context.arg = record.arg); } }; } function maybeInvokeDelegate(delegate, context) { var methodName = context.method, method = delegate.iterator[methodName]; if (undefined === method) return context.delegate = null, "throw" === methodName && delegate.iterator["return"] && (context.method = "return", context.arg = undefined, maybeInvokeDelegate(delegate, context), "throw" === context.method) || "return" !== methodName && (context.method = "throw", context.arg = new TypeError("The iterator does not provide a '" + methodName + "' method")), ContinueSentinel; var record = tryCatch(method, delegate.iterator, context.arg); if ("throw" === record.type) return context.method = "throw", context.arg = record.arg, context.delegate = null, ContinueSentinel; var info = record.arg; return info ? info.done ? (context[delegate.resultName] = info.value, context.next = delegate.nextLoc, "return" !== context.method && (context.method = "next", context.arg = undefined), context.delegate = null, ContinueSentinel) : info : (context.method = "throw", context.arg = new TypeError("iterator result is not an object"), context.delegate = null, ContinueSentinel); } function pushTryEntry(locs) { var entry = { tryLoc: locs[0] }; 1 in locs && (entry.catchLoc = locs[1]), 2 in locs && (entry.finallyLoc = locs[2], entry.afterLoc = locs[3]), this.tryEntries.push(entry); } function resetTryEntry(entry) { var record = entry.completion || {}; record.type = "normal", delete record.arg, entry.completion = record; } function Context(tryLocsList) { this.tryEntries = [{ tryLoc: "root" }], tryLocsList.forEach(pushTryEntry, this), this.reset(!0); } function values(iterable) { if (iterable) { var iteratorMethod = iterable[iteratorSymbol]; if (iteratorMethod) return iteratorMethod.call(iterable); if ("function" == typeof iterable.next) return iterable; if (!isNaN(iterable.length)) { var i = -1, next = function next() { for (; ++i < iterable.length;) if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; return next.value = undefined, next.done = !0, next; }; return next.next = next; } } return { next: doneResult }; } function doneResult() { return { value: undefined, done: !0 }; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), defineProperty(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) { var ctor = "function" == typeof genFun && genFun.constructor; return !!ctor && (ctor === GeneratorFunction || "GeneratorFunction" === (ctor.displayName || ctor.name)); }, exports.mark = function (genFun) { return Object.setPrototypeOf ? Object.setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = Object.create(Gp), genFun; }, exports.awrap = function (arg) { return { __await: arg }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, asyncIteratorSymbol, function () { return this; }), exports.AsyncIterator = AsyncIterator, exports.async = function (innerFn, outerFn, self, tryLocsList, PromiseImpl) { void 0 === PromiseImpl && (PromiseImpl = Promise); var iter = new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList), PromiseImpl); return exports.isGeneratorFunction(outerFn) ? iter : iter.next().then(function (result) { return result.done ? result.value : iter.next(); }); }, defineIteratorMethods(Gp), define(Gp, toStringTagSymbol, "Generator"), define(Gp, iteratorSymbol, function () { return this; }), define(Gp, "toString", function () { return "[object Generator]"; }), exports.keys = function (val) { var object = Object(val), keys = []; for (var key in object) keys.push(key); return keys.reverse(), function next() { for (; keys.length;) { var key = keys.pop(); if (key in object) return next.value = key, next.done = !1, next; } return next.done = !0, next; }; }, exports.values = values, Context.prototype = { constructor: Context, reset: function reset(skipTempReset) { if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = undefined); }, stop: function stop() { this.done = !0; var rootRecord = this.tryEntries[0].completion; if ("throw" === rootRecord.type) throw rootRecord.arg; return this.rval; }, dispatchException: function dispatchException(exception) { if (this.done) throw exception; var context = this; function handle(loc, caught) { return record.type = "throw", record.arg = exception, context.next = loc, caught && (context.method = "next", context.arg = undefined), !!caught; } for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i], record = entry.completion; if ("root" === entry.tryLoc) return handle("end"); if (entry.tryLoc <= this.prev) { var hasCatch = hasOwn.call(entry, "catchLoc"), hasFinally = hasOwn.call(entry, "finallyLoc"); if (hasCatch && hasFinally) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } else if (hasCatch) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); } else { if (!hasFinally) throw new Error("try statement without catch or finally"); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } } } }, abrupt: function abrupt(type, arg) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc <= this.prev && hasOwn.call(entry, "finallyLoc") && this.prev < entry.finallyLoc) { var finallyEntry = entry; break; } } finallyEntry && ("break" === type || "continue" === type) && finallyEntry.tryLoc <= arg && arg <= finallyEntry.finallyLoc && (finallyEntry = null); var record = finallyEntry ? finallyEntry.completion : {}; return record.type = type, record.arg = arg, finallyEntry ? (this.method = "next", this.next = finallyEntry.finallyLoc, ContinueSentinel) : this.complete(record); }, complete: function complete(record, afterLoc) { if ("throw" === record.type) throw record.arg; return "break" === record.type || "continue" === record.type ? this.next = record.arg : "return" === record.type ? (this.rval = this.arg = record.arg, this.method = "return", this.next = "end") : "normal" === record.type && afterLoc && (this.next = afterLoc), ContinueSentinel; }, finish: function finish(finallyLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.finallyLoc === finallyLoc) return this.complete(entry.completion, entry.afterLoc), resetTryEntry(entry), ContinueSentinel; } }, "catch": function _catch(tryLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc === tryLoc) { var record = entry.completion; if ("throw" === record.type) { var thrown = record.arg; resetTryEntry(entry); } return thrown; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(iterable, resultName, nextLoc) { return this.delegate = { iterator: values(iterable), resultName: resultName, nextLoc: nextLoc }, "next" === this.method && (this.arg = undefined), ContinueSentinel; } }, exports; }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var CertificateSettingsController = /*#__PURE__*/function (_NetCityModalControll) {
  CertificateSettingsController.$inject = ["$scope", "language", "appContext", "$dialogs", "$uibModalInstance", "changeTracker", "certifSettingsRepository", "$alerts", "$longWork"];
  _inherits(CertificateSettingsController, _NetCityModalControll);
  var _super = _createSuper(CertificateSettingsController);
  /*@ngInject*/
  function CertificateSettingsController($scope, language, appContext, $dialogs, $uibModalInstance, changeTracker, certifSettingsRepository, $alerts, $longWork) {
    var _this;
    _classCallCheck(this, CertificateSettingsController);
    _this = _super.call(this, $scope, $uibModalInstance, changeTracker, $dialogs);
    _this.$scope = $scope;
    _this.language = language;
    ...
    _this.$alerts = $alerts;
    _this.$longWork = $longWork;
    _this.header = "Настройки";
    _this.initButtons();
    _this.load();
    return _this;
  }
  _createClass(CertificateSettingsController, [{
    key: "load",
    value: function load() {
      var _this2 = this;
      this.emId = this.appContext.emId;
      var task = this.certifSettingsRepository.getEmCertificateSettings().then(function (resp) {
        return _this2.certifSettings = resp;
      });
      this.$longWork.execute(task);
    }
  }, {
    key: "initButtons",
    ...
    key: "getParentCertificateBlank",
    value: function getParentCertificateBlank() {
      return this.certifSettingsRepository.getParentCertificateBlank();
    }
  }, {
    key: "saveParentCertificateBlank",
    value: function saveParentCertificateBlank(file) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var uploadTask;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              if (!this.certifSettings.hasParentApplicationBlank) {
                _context.next = 5;
                break;
              }
              _context.next = 5;
              return this.$dialogs.confirm(this.language.Generic.EM.kSureSaveTemplate);
            case 5:
              uploadTask = this.certifSettingsRepository.uploadParentCertificateBlank(this.emId, file);
              _context.next = 8;
              return this.$longWork.execute(uploadTask);
            case 8:
              this.certifSettings.hasParentApplicationBlank = true;
              this.$alerts.success(this.language.Generic.EM.kSaveTemplateSuccess);
              this.$scope.$applyAsync();
            case 11:
            case "end":
              return _context.stop();
    ...
    key: "deleteParentCertificateBlank",
    value: function deleteParentCertificateBlank() {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this4 = this;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              this.$dialogs.confirmDelete(this.language.Generic.EM.kSureDeleteTemplate).then(function () {
                var task = _this4.certifSettingsRepository.deleteParentCertificateBlank(_this4.emId).then(function () {
                  _this4.certifSettings.hasParentApplicationBlank = false;
                  _this4.$alerts.success(_this4.language.Generic.EM.kDeleteTemplateSuccess);
                });
                _this4.$longWork.execute(task);
              });
            case 1:
            case "end":
    ...
    key: "getStudentCertificateBlank",
    value: function getStudentCertificateBlank() {
      return this.certifSettingsRepository.getStudentCertificateBlank();
    }
  }, {
    key: "saveStudentCertificateBlank",
    value: function saveStudentCertificateBlank(file) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              if (!this.certifSettings.hasStudentApplicationBlank) {
                _context3.next = 5;
                break;
              }
              _context3.next = 5;
              return this.$dialogs.confirm(this.language.Generic.EM.kSureSaveTemplate);
            case 5:
              uploadTask = this.certifSettingsRepository.uploadStudentCertificateBlank(this.emId, file);
              _context3.next = 8;
              return this.$longWork.execute(uploadTask);
            case 8:
              this.certifSettings.hasStudentApplicationBlank = true;
              this.$alerts.success(this.language.Generic.EM.kSaveTemplateSuccess);
              this.$scope.$applyAsync();
            case 11:
            case "end":
    ...
    key: "deleteStudentCertificateBlank",
    value: function deleteStudentCertificateBlank() {
      var _this5 = this;
      this.$dialogs.confirmDelete(this.language.Generic.EM.kSureDeleteTemplate).then(function () {
        var task = _this5.certifSettingsRepository.deleteStudentCertificateBlank(_this5.emId).then(function () {
          _this5.certifSettings.hasStudentApplicationBlank = false;
          _this5.$alerts.success(_this5.language.Generic.EM.kDeleteTemplateSuccess);
        });
        _this5.$longWork.execute(task);
      });
    }
  }, {
    key: "save",
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              this.form.minCertifiateStudentAge.$touched = true;
              if (!this.form.$invalid) {
                _context4.next = 3;
                break;
              }
            ...
            case 3:
              saveTask = this.certifSettingsRepository.setEmCertifMinStudentAge(this.emId, this.certifSettings.minCertifiateStudentAge);
              _context4.next = 6;
              return this.$longWork.execute(saveTask);
            case 6:
              this.$alerts.success("Настройки успешно сохранены");
              this.cancel();
              this.$scope.$applyAsync();
            case 9:
            case "end":
  ...
  return CertificateSettingsController;
}(_netcityModalCtrl.NetCityModalController);
var CertificateSettingsComponent = {
  controller: CertificateSettingsController,
  controllerAs: "$ctrl",
  templateUrl: "/static/dist/app/em/educcertificates/settings/certifSettings.component.html"
};
exports.CertificateSettingsComponent = CertificateSettingsComponent;
...
angular.module("irtech.netcity.em.educcertificates").controller("SearchEducCertifCtrl", function ($scope, $http, $document, $location, $appLoader, $uibModal, $uibModalInstance, $alerts, $q, $dialogs, certifRepository, $longWork) {
  $scope.certifNumber = undefined;
  $scope.lastname = undefined;
  $scope.firstname = undefined;
  $scope.middlename = undefined;
  $scope.noMiddlename = undefined;
  $scope.isSearchComplete = undefined;
  $scope.isCertifNotFinded = true;
  $scope.isValidForm = function () {
    var middlename = $scope.noMiddlename ? true : $scope.middlename;
    var isFioFill = $scope.lastname && $scope.firstname && middlename && true;
    var isCertNumberFill = $scope.certifNumber && true;
    var res = isFioFill || isCertNumberFill;
    return res;
  };
  $.extend($scope, {
    language: language
  ...
  $scope.search = function () {
    ...
    $scope.isCertifNotFinded = true;
    var searchData = {
      ceretNumber: $scope.certifNumber || '',
      lastname: $scope.lastname || '',
      firstname: $scope.firstname || '',
      middlename: $scope.middlename || '',
      noMiddlename: $scope.noMiddlename || false
    };
    if (!$longWork.isShowing) $longWork.show();
    var searchCertificatePromise = certifRepository.searchCertificate(searchData);
    var getChildEmWithMainPromise = certifRepository.getChildEmWithMain();
    Promise.all([searchCertificatePromise, getChildEmWithMainPromise]).then(function (data) {
      var findedCertificates = data[0];
      var childEmsWithMain = data[1];

      //првоерить что текущий муниципалитет сертификата есть в списке из доступных муниципалитетов, если его там нет, то добавить
      var _loop = function _loop() {
        var cert = findedCertificates[i];
        cert.municipalitetList = childEmsWithMain;
        var isCurrentMunicipalitetInList = cert.municipalitetList.some(function (x) {
          return x.id == cert.currentMunicipalitet.id;
        });
        if (!isCurrentMunicipalitetInList) {
          cert.municipalitetList.push(cert.currentMunicipalitet);
        }
      };
      for (var i = 0; i < findedCertificates.length; i++) {
        _loop();
      }
      $scope.isSearchCompleted = true;
      if (findedCertificates.length < 1) {
        $scope.isCertifNotFinded = true;
      } else {
        $scope.isCertifNotFinded = false;
        $scope.findCertifStudList = findedCertificates;
        $scope.municipalitetList = childEmsWithMain;
      }

      //вручную запускаю дайджест цикл
      $scope.$digest();
    })["finally"](function () {
      return $longWork.close();
    });
  };
  ...
  $scope.save = function () {
    var data = $scope.findCertifStudList;
    if (!$longWork.isShowing) $longWork.show();
    certifRepository.updateMunicipalitetForCertif(data).then(function (response) {
      return $uibModalInstance.dismiss("cancel");
    }).then(function () {
      $alerts.success("Сертификат успешно сохранён");
    })["finally"](function () {
      return $longWork.close();
    });
  };
