...
var _eminfo = __webpack_require__(2);
var _eminfo2 = __webpack_require__(6);
var _module = angular.module("irtech.netcity.em.eminfo", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "irtech.netcity.common", "irtech.netcity.ui-components"]);
/*@ngInject*/
var config = function config($routeProvider, $locationProvider) {
  $routeProvider.when('/', _eminfo.EmInfoComponent).otherwise(_eminfo.EmInfoComponent);
  ;
...
_module.service("emInfoRepository", _eminfo2.EmInfoRepository).directive("innInput", _eminfo.InnInputDirective).directive("ogrnInput", _eminfo.OgrnInputDirective)
//.service("foodPayBalanceRepository", FoodPayBalanceRepository)
.config(config);
...
exports.OgrnInputDirective = exports.InnInputDirective = exports.EmInfoComponent = void 0;
...
var EmInfoController = /*#__PURE__*/function () {
  EmInfoController.$inject = ["pageContext", "$scope", "$appLoader", "$longWork", "$alerts", "appContext", "changeTracker", "emInfoRepository", "language"];
  /*@ngInject*/
  function EmInfoController(pageContext, $scope, $appLoader, $longWork, $alerts, appContext, changeTracker, emInfoRepository, language) {
    _classCallCheck(this, EmInfoController);
    this.$scope = $scope;
    ...
    this.emInfoRepository = emInfoRepository;
    this.language = language;
    pageContext.title = "Карточка УО";
    pageContext.parent = null;
    pageContext.back = null;
    this.init();
  }
  _createClass(EmInfoController, [{
    key: "init",
    value: function init() {
      var _this = this;
      this.filterPanelSettings = {
        url: "/webapi/em/card/filterpanel",
        initUrl: "/webapi/em/card/initfilters",
        styles: {
          compact: false
        },
        events: {
      ...
      this.emInfoRepository.loadEmInfo(this.appContext.emId).then(function (emInfo) {
        _this.emCardInfo = emInfo;
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              work = this.emInfoRepository.saveEmInfo(this.appContext.emId, this.emCardInfo);
              _context.next = 5;
    ...
    value: function login() {
      var emSchoolId = this.filterPanel.getValues().EMSCHOOLID;
      ...
      (0, _common.postTo)("/webapi/dologin", {
        SCID: emSchoolId,
  ...
  return EmInfoController;
}();
var EmInfoComponent = {
  controller: EmInfoController,
  controllerAs: "$ctrl",
  templateUrl: "/static/dist/app/em/eminfo/eminfo.component.html"
};
exports.EmInfoComponent = EmInfoComponent;
var InnInputDirective = function InnInputDirective() {
  return {
    require: 'ngModel',
    link: function link(scope, element, attrs, ngModel) {
      ngModel.$validators.inn = function (modelValue, viewValue) {
        if (ngModel.$isEmpty(modelValue)) {
          return false;
        }
        if (modelValue.length != 10 && modelValue.length != 12) {
          return false;
        }
        if (/^\d+$/g.test(modelValue)) {
          return true;
        }
        return false;
      };
...
var OgrnInputDirective = function OgrnInputDirective() {
  return {
    require: 'ngModel',
    link: function link(scope, element, attrs, ngModel) {
      ngModel.$validators.ogrn = function (modelValue, viewValue) {
        if (ngModel.$isEmpty(modelValue)) {
          return false;
        }
