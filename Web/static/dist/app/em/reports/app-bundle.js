...
exports.EmReportListController = void 0;
var _reports = __webpack_require__(354);
var _reportlist = __webpack_require__(355);
var _report = __webpack_require__(356);
...
var _module = angular.module("irtech.netcity.em.reports", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "irtech.netcity.common", "ngFileUpload", "ui.tree", "irtech.netcity.ui-components"]);
var EmReportListController = /*#__PURE__*/function (_ReportListController) {
  _inherits(EmReportListController, _ReportListController);
  var _super = _createSuper(EmReportListController);
  function EmReportListController() {
    _classCallCheck(this, EmReportListController);
    return _super.apply(this, arguments);
  }
  _createClass(EmReportListController, [{
    key: "openLegacyReport",
    value: function openLegacyReport(report) {
      var path = report.path;
      if (!path.startsWith("/")) {
        path = "/asp/EDUC_MANAGER/Reports/".concat(path);
      }
      (0, _common.postTo)({
        path: path,
        params: {
  ...
  return EmReportListController;
}(_reportlist.ReportListController);
exports.EmReportListController = EmReportListController;
var EMReportListComponent = {
  controller: EmReportListController,
  controllerAs: _reportlist.ReportListComponent.controllerAs,
  templateUrl: _reportlist.ReportListComponent.templateUrl
};
/*@ngInject*/
var config = function config($routeProvider, $locationProvider) {
  $routeProvider.when("/list/", EMReportListComponent).when("/:reportId", _report.ReportComponent).otherwise(EMReportListComponent);
...
_module.service("reportsRepository", _reports.ReportsRepository).service("pooReportApi", _reports.PooReportApi).config(config);
...
exports.SchoolReportListController = exports.ReportListController = exports.ReportListComponent = void 0;
var _common = __webpack_require__(3);
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ReportListController = /*#__PURE__*/function () {
  ReportListController.$inject = ["pageContext", "$location", "$dialogs", "$appLoader", "language", "reportsRepository"];
  /*@ngInject*/
  function ReportListController(pageContext, $location, $dialogs, $appLoader, language, reportsRepository) {
    var _this = this;
    _classCallCheck(this, ReportListController);
    this.$location = $location;
    this.$dialogs = $dialogs;
    this.language = language;
    this.reportGroups = [];
    pageContext.title = language.Generic.MenuFolders.kFNReports;
    pageContext.parent = null;
    reportsRepository.getReportList().then(function (reportGroups) {
      _this.reportGroups = reportGroups;
      $appLoader.hide();
    });
  }
  _createClass(ReportListController, [{
    key: "viewReport",
    value: function viewReport(report) {
      if (report.path && !report.path.endsWith("Report.asp")) {
        this.openLegacyReport(report);
      } else {
        this.$location.path("".concat(report.id.toLowerCase()));
      }
    }
  }, {
    key: "showNoticeError",
    value: function showNoticeError(notices) {
      this.$dialogs.error(notices.errorDescription);
    }
  }]);
  return ReportListController;
}();
exports.ReportListController = ReportListController;
var SchoolReportListController = /*#__PURE__*/function (_ReportListController) {
  _inherits(SchoolReportListController, _ReportListController);
  var _super = _createSuper(SchoolReportListController);
  function SchoolReportListController() {
    _classCallCheck(this, SchoolReportListController);
    return _super.apply(this, arguments);
  }
  _createClass(SchoolReportListController, [{
    key: "openLegacyReport",
    value: function openLegacyReport(report) {
      (0, _common.postTo)({
        path: report.path,
  ...
  return SchoolReportListController;
}(ReportListController);
exports.SchoolReportListController = SchoolReportListController;
var ReportListComponent = {
  controller: SchoolReportListController,
  controllerAs: "ctrl",
  templateUrl: "/static/dist/app/school/reports/list/reportlist.component.html",
...
var _reports = __webpack_require__(354);
var _commonRouting = __webpack_require__(331);
var _graph = __webpack_require__(357);
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { "default": obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj["default"] = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
