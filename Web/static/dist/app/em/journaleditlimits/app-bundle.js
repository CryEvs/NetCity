...
var _journaleditlimits = __webpack_require__(376);
var _journaleditlimits2 = __webpack_require__(377);
var _editlimit = __webpack_require__(378);
var _editlimits = __webpack_require__(379);
var _module = angular.module("irtech.netcity.em.journaleditlimits", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "ngFileUpload", "ui.tree", "irtech.netcity.common", "irtech.netcity.ui-components"]);
_module.service("journalEditLimitsRepository", _journaleditlimits2.JournalEditLimitsRepository).component(_editlimit.EditLimitComponent.selector, _editlimit.EditLimitComponent).component(_editlimits.EditLimitsComponent.selector, _editlimits.EditLimitsComponent).config(function ($routeProvider, $locationProvider) {
  $routeProvider.when("/", _journaleditlimits.JournalEditLimitsComponent).otherwise(_journaleditlimits.JournalEditLimitsComponent);
...
exports.JournalEditLimitsComponent = void 0;
...
var JournalEditLimitsController = /*#__PURE__*/function () {
  JournalEditLimitsController.$inject = ["pageContext", "$location", "$appLoader", "$dialogs", "$alerts", "$longWork", "$q", "language", "journalEditLimitsRepository"];
  /*@ngInject*/
  function JournalEditLimitsController(pageContext, $location, $appLoader, $dialogs, $alerts, $longWork, $q, language, journalEditLimitsRepository) {
    var _this = this;
    _classCallCheck(this, JournalEditLimitsController);
    ...
    this.filterPanelSettings = {
      url: "/webapi/em/journaleditlimits/filter",
      styles: {
        compact: false
      },
      events: {
    ...
    pageContext.title = this.language.Generic.MenuFolders.kJournalEditLimits;
  }
  _createClass(JournalEditLimitsController, [{
    key: "load",
    value: function load() {
      var _this2 = this;
      var values = this.filterPanel.getValues();
      if (values.OrganizationFilter && values.OrganizationFilter != "-1") {
        this.schoolId = values.OrganizationFilter;
      } else {
        this.schoolId = null;
      }
      this.emId = values.EMID;
      var promises = [this.journalEditLimitsRepository.getEditLimits(this.schoolId, this.emId).then(function (result) {
        _this2.resultsAttendancePastEditDays = result.resultsAttendancePastEditValue;
        _this2.resultsAttendancePastEditChecked = _this2.resultsAttendancePastEditDays > 0;
        _this2.totalsPastEditDays = result.totalsPastEditValue;
        _this2.totalsPastEditChecked = _this2.totalsPastEditDays > 0;
        _this2.futureEditDays = result.futureEdit;
        _this2.futureEditChecked = _this2.futureEditDays > 0;
      })];
      this.resultsAttendancePastEditActual = null;
      this.totalsPastEditActual = null;
      this.futureEditActual = null;
      if (this.schoolId) {
        promises.push(this.journalEditLimitsRepository.getActualEditLimits(this.schoolId).then(function (result) {
          _this2.resultsAttendancePastEditActual = result.resultsAttendancePastEditActualValue;
          _this2.totalsPastEditActual = result.totalsPastEditActualValue;
          _this2.futureEditActual = result.futureEditActualValue;
        }));
      }
    ...
    value: function save() {
      ...
      var editJournalLimitsDto = {
        resultsAttendancePastEditValue: this.resultsAttendancePastEditChecked ? this.resultsAttendancePastEditDays : 0,
        totalsPastEditValue: this.totalsPastEditChecked ? this.totalsPastEditDays : 0,
        futureEdit: this.futureEditChecked ? this.futureEditDays : 0
      };
      this.$longWork.execute(this.journalEditLimitsRepository.setEditLimits(this.schoolId, this.emId, editJournalLimitsDto)).then(function () {
        _this3.$alerts.success("Данные о лимитах сохранены");
        _this3.load();
      });
    }
  }]);
  return JournalEditLimitsController;
}();
var JournalEditLimitsComponent = {
  controller: JournalEditLimitsController,
  controllerAs: "ctrl",
  templateUrl: "/static/dist/app/em/journaleditlimits/journaleditlimits.component.html"
};
exports.JournalEditLimitsComponent = JournalEditLimitsComponent;
