...
var _timeInput = __webpack_require__(281);
var _mobileAppNotifications = __webpack_require__(282);
var _mobileAppNotifications2 = __webpack_require__(284);
var _module = angular.module("irtech.netcity.admin.mobileappnotifications", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "irtech.netcity.common", "irtech.netcity.ui-components"]);
_module.service("mobileAppNotificationsRepository", _mobileAppNotifications2.MobileAppNotificationsRepository).directive("timeInput", _timeInput.TimeInputDirective).config(function ($routeProvider, $locationProvider) {
  $routeProvider.when("/", _mobileAppNotifications.MobileAppNotificationsComponent);
...
exports.MobileAppNotificationsComponent = void 0;
var _registry = __webpack_require__(3);
var _nsModal = __webpack_require__(6);
var _editMobileAppNotifications = __webpack_require__(283);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var MobileAppNotificationsController = /*#__PURE__*/function () {
  MobileAppNotificationsController.$inject = ["pageContext", "appContext", "$dialogs", "$longWork", "$alerts", "$uibModal", "mobileAppNotificationsRepository", "language"];
  /*@ngInject*/
  function MobileAppNotificationsController(pageContext, appContext, $dialogs, $longWork, $alerts, $uibModal, mobileAppNotificationsRepository, language) {
    var _this = this;
    _classCallCheck(this, MobileAppNotificationsController);
    this.appContext = appContext;
    this.$dialogs = $dialogs;
    this.$longWork = $longWork;
    this.$alerts = $alerts;
    this.$uibModal = $uibModal;
    this.mobileAppNotificationsRepository = mobileAppNotificationsRepository;
    this.language = language;
    pageContext.title = "Оповещения пользователей мобильного приложения";
    ...
    this.registryInfo = {
      url: "/webapi/admin/mobile-app-notifications/registry",
      filtersUrl: "/webapi/admin/mobile-app-notifications/registry/filter",
      buttons: buttons,
      fieldDecorators: {
  ...
  _createClass(MobileAppNotificationsController, [{
    key: "add",
    value: function add() {
      var _this2 = this;
      var notification = {
      ...
      var modal = this.openNotificationInfo(notification);
    ...
    value: function edit() {
      var _this3 = this;
      var notification = this.prepareNotification();
      var modal = this.openNotificationInfo(notification);
      modal.result.then(function () {
    ...
    value: function prepareNotification() {
      var selection = this.controller.selection.items[0];
      var notification = {
        id: parseInt(selection.id),
        startDate: new Date(selection.startDate),
        endDate: new Date(selection.endDate),
        text: selection.text,
        blockWorking: selection.blockWorking == "да",
        multipleTimes: selection.multipleTimes == "да"
      };
      return notification;
    }
  }, {
    key: "openNotificationInfo",
    value: function openNotificationInfo(_notification) {
      return this.$uibModal.open({
        controller: _editMobileAppNotifications.EditeMobileAppNotificationsComponent.controller,
        controllerAs: "$ctrl",
        templateUrl: _editMobileAppNotifications.EditeMobileAppNotificationsComponent.templateUrl,
        backdrop: false,
        size: "lg",
        resolve: {
    ...
    value: function _delete() {
      var _this4 = this;
      var selectedNotification = this.controller.selection.items[0];
      var notificationId = selectedNotification.id;
      this.$dialogs.confirmDelete("Удалить оповещение?").then(function () {
        var deleteNotificationTask = _this4.mobileAppNotificationsRepository.removeNotification(notificationId);
        return _this4.$longWork.execute(deleteNotificationTask).then(function () {
          _this4.$alerts.success("Оповещение успешно удалено");
          _this4.controller.load();
        });
      }, function () {});
    }
  }]);
  return MobileAppNotificationsController;
}();
var MobileAppNotificationsComponent = {
  template: "<registry info=\"$ctrl.registryInfo\" controller=\"$ctrl.controller\"></registry>",
  controller: MobileAppNotificationsController,
  controllerAs: "$ctrl"
};
exports.MobileAppNotificationsComponent = MobileAppNotificationsComponent;
...
exports.EditeMobileAppNotificationsComponent = void 0;
...
var EditeMobileAppNotificationsController = /*#__PURE__*/function (_NetCityModalControll) {
  EditeMobileAppNotificationsController.$inject = ["$scope", "$uibModalInstance", "changeTracker", "$dialogs", "$timeout", "dateUtils", "$longWork", "$alerts", "mobileAppNotificationsRepository", "language", "notification"];
  _inherits(EditeMobileAppNotificationsController, _NetCityModalControll);
  var _super = _createSuper(EditeMobileAppNotificationsController);
  /*@ngInject*/
  function EditeMobileAppNotificationsController($scope, $uibModalInstance, changeTracker, $dialogs, $timeout, dateUtils, $longWork, $alerts, mobileAppNotificationsRepository, language, notification) {
    var _this;
    _classCallCheck(this, EditeMobileAppNotificationsController);
    _this = _super.call(this, $scope, $uibModalInstance, changeTracker, $dialogs);
    _this.$timeout = $timeout;
    _this.dateUtils = dateUtils;
    _this.$longWork = $longWork;
    _this.$alerts = $alerts;
    _this.mobileAppNotificationsRepository = mobileAppNotificationsRepository;
    _this.language = language;
    _this.notification = notification;
    _this.buttons = [];
    // объект валидации
    _this.validation = {
      dateInvalidMessage: _this.language.Generic.Common.kEnterDateInFormat + " " + _this.dateUtils.getLocaleFormat(),
      timeInvalidMessage: "Введите время в формате HH:mm",
      rangeInvalidMessage: "Дата окончания должна быть больше или равна даты начала",
      afterMinDateMessage: function afterMinDateMessage() {
        return _this.editMode ? "Дату редактируемого оповещения нельзя сделать ранее сохраненной даты начала" : "Дата нового оповещения больше или равна текущей даты";
      },
      startBeforeEndMessage: _this.language.Generic.Common.kMsgStartBeforeEnd,
      textInvalidMessage: "Введите текст оповещения",
      isStartDateValid: function isStartDateValid() {
        return !(_this.form.startDate && _this.form.startDate.$invalid && (_this.form.startDate.$dirty || _this.form.$displayErrors));
      },
      isStartTimeValid: function isStartTimeValid() {
        return !(_this.form.startTime && _this.form.startTime.$invalid && (_this.form.startTime.$dirty || _this.form.$displayErrors));
      },
      isEndDateValid: function isEndDateValid() {
        var _a, _b;
        return !(_this.form.endDate && ((_a = _this.form.endDate) === null || _a === void 0 ? void 0 : _a.$invalid) && (((_b = _this.form.endDate) === null || _b === void 0 ? void 0 : _b.$dirty) || _this.form.$displayErrors));
      },
      isEndTimeValid: function isEndTimeValid() {
        return !(_this.form.endTime && _this.form.endTime.$invalid && (_this.form.endTime.$dirty || _this.form.$displayErrors));
      },
      isAfterMinDateValid: function isAfterMinDateValid() {
        var _a, _b, _c, _d, _e;
        var startDate = (_a = _this.form.startDate) === null || _a === void 0 ? void 0 : _a.$modelValue;
        var startTime = (_b = _this.form.startTime) === null || _b === void 0 ? void 0 : _b.$modelValue;
        if (!startDate) {
          return true;
        }
        var today = _this.dateUtils.asDateTime(new Date());
        today.setSeconds(0);
        today.setMilliseconds(0);
        var minDate = !_this.editMode ? today : ((_d = (_c = _this.notification) === null || _c === void 0 ? void 0 : _c.startDate) === null || _d === void 0 ? void 0 : _d.getTime()) < today.getTime() ? (_e = _this.notification) === null || _e === void 0 ? void 0 : _e.startDate : today;
        var startDateWithTime = angular.copy(startDate);
        startDateWithTime.setHours(startTime.getHours());
        startDateWithTime.setMinutes(startTime.getMinutes());
        var afterMinDate = startDateWithTime.getTime() >= minDate.getTime();
        return afterMinDate;
      },
      isRangeValid: function isRangeValid() {
        var _a, _b, _c, _d, _e, _f;
        if (!_this.form.$displayErrors && (!_this.form || !((_a = _this.form.endDate) === null || _a === void 0 ? void 0 : _a.$dirty) && !((_b = _this.form.endDate) === null || _b === void 0 ? void 0 : _b.$modelValue))) {
          return true;
        }
        var startDate = (_c = _this.form.startDate) === null || _c === void 0 ? void 0 : _c.$modelValue;
        var endDate = (_d = _this.form.endDate) === null || _d === void 0 ? void 0 : _d.$modelValue;
        var startTime = (_e = _this.form.startTime) === null || _e === void 0 ? void 0 : _e.$modelValue;
        var endTime = (_f = _this.form.endTime) === null || _f === void 0 ? void 0 : _f.$modelValue;
        var existsDateValues = startDate && startTime && endDate && endTime;
        if (!existsDateValues) {
          return false;
        }
        var startBeforeEnd = startDate.getTime() < endDate.getTime() || startDate.getTime() == endDate.getTime() && startTime.getTime() <= endTime.getTime();
        return startBeforeEnd;
      },
      isStartBeforeEnd: function isStartBeforeEnd() {
        return _this.notification.startDate > _this.notification.endDate;
      },
      isTextValid: function isTextValid() {
        return !(_this.form.name && _this.form.name.$invalid && (_this.form.name.$dirty || _this.form.$displayErrors));
      }
    };
    _this.editMode = notification.id > 0;
    _this.header = _this.editMode ? "Редактировать оповещение" : "Добавить оповещение";
    var saveButton = {
  ...
  _createClass(EditeMobileAppNotificationsController, [{
    key: "$onInit",
    value: function $onInit() {
      var _this2 = this;
      var tmpDate = new Date(1900, 1, 1, 0, 0);
      // время
      this.startTime = angular.copy(tmpDate);
      this.endTime = angular.copy(tmpDate);
      if (this.notification.startDate) {
        var inputStartDate = this.notification.startDate;
        this.startDate = this.dateUtils.asUTCDate(inputStartDate);
        this.copyTime(this.startTime, inputStartDate);
      }
      if (this.notification.endDate) {
        var inputEndDate = this.notification.endDate;
        this.endDate = this.dateUtils.asUTCDate(inputEndDate);
        this.copyTime(this.endTime, inputEndDate);
      }
    ...
    key: "copyTime",
    value: function copyTime(dateIn, dateFrom) {
      dateIn.setHours(dateFrom.getHours());
      dateIn.setMinutes(dateFrom.getMinutes());
      dateIn.setSeconds(0);
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!(this.form.$invalid || !this.validation.isStartDateValid() || !this.validation.isStartTimeValid() || !this.validation.isAfterMinDateValid() || !this.validation.isEndDateValid() || !this.validation.isEndTimeValid() || !this.validation.isRangeValid() || !this.validation.isTextValid())) {
                _context.next = 3;
                break;
              }
            ...
            case 3:
              this.notification.startDate = this.dateUtils.asUTCDate(this.startDate);
              this.copyTime(this.notification.startDate, this.startTime);
              this.notification.endDate = this.dateUtils.asUTCDate(this.endDate);
              this.copyTime(this.notification.endDate, this.endTime);
              if (!this.validation.isStartBeforeEnd()) {
                _context.next = 10;
                break;
              }
              this.$alerts.error(this.validation.startBeforeEndMessage);
              return _context.abrupt("return");
            case 10:
              _context.next = 12;
              return this.$longWork.execute(this.mobileAppNotificationsRepository.createOrEditNotification(this.notification));
            case 12:
              if (this.editMode) {
                this.$alerts.success("Оповещение успешно изменено");
              } else {
                this.$alerts.success("Оповещение успешно добавлено");
              }
  ...
  return EditeMobileAppNotificationsController;
}(_netcityModalCtrl.NetCityModalController);
var EditeMobileAppNotificationsComponent = {
  controller: EditeMobileAppNotificationsController,
  controllerAs: "$ctrl",
  templateUrl: "/static/dist/app/admin/mobileappnotifications/edit.mobile-app.notifications.component.html"
};
exports.EditeMobileAppNotificationsComponent = EditeMobileAppNotificationsComponent;
...
exports.MobileAppNotificationsRepository = void 0;
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var MobileAppNotificationsRepository = /*#__PURE__*/function (_BaseRepository) {
  _inherits(MobileAppNotificationsRepository, _BaseRepository);
  var _super = _createSuper(MobileAppNotificationsRepository);
  function MobileAppNotificationsRepository() {
    _classCallCheck(this, MobileAppNotificationsRepository);
    return _super.apply(this, arguments);
  }
  _createClass(MobileAppNotificationsRepository, [{
    key: "createOrEditNotification",
    value: function createOrEditNotification(request) {
      return this.$http.put("/webapi/admin/mobile-app-notifications", request).then(this.handleResponse, this.handleError);
    }
  }, {
    key: "removeNotification",
    value: function removeNotification(notificationId) {
      return this.$http["delete"]("/webapi/admin/mobile-app-notifications/".concat(notificationId)).then(this.handleResponse, this.handleError);
    }
  }]);
  return MobileAppNotificationsRepository;
}(_baseRepository.BaseRepository);
exports.MobileAppNotificationsRepository = MobileAppNotificationsRepository;
