...
var _usermon = __webpack_require__(33);
var _userEvents = __webpack_require__(36);
var _userStat = __webpack_require__(37);
var _sessions = __webpack_require__(38);
var _sessionsmon = __webpack_require__(39);
var _module = angular.module("irtech.netcity.admin.stats", ["ngRoute", "ngSanitize", "ngMessages", "ui.select", "uikit.alerts", "uikit.dialogs", "ui.bootstrap", "irtech.netcity.common", "ngFileUpload", "ui.tree", "irtech.netcity.ui-components"]);
_module.service("sessionsRepository", _sessions.SessionsRepository).config(function ($routeProvider, $locationProvider) {
  $routeProvider.when("/usermon/", _usermon.UserMonintorComponent).when("/sessionsmon/", _sessionsmon.SessionsMonitorRegistryComponent).when("/userevents/", _userEvents.UserEventsRegistryComponent).when("/userstat/", _userStat.UserStatRegistryComponent).otherwise({
    redirectTo: "/usermon/"
  });
...
exports.UserMonintorComponent = void 0;
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var UserMonintorController = /*#__PURE__*/function () {
  function UserMonintorController(pageContext, sessionsRepository, $longWork, $alerts, $appLoader, $location, language) {
    var _this = this;
    _classCallCheck(this, UserMonintorController);
    ...
    this["delete"] = function () {
      var selected = _this.data.selection.selected;
      var at = selected.map(function (s) {
        return s.at;
      });
      _this.$longWork.show();
      _this.sessionsRepository.killSessions(at).then(function () {
        _this.$longWork.close();
        _this.$alerts.success("Сессии успешно удалены");
        _this.load();
      });
    };
    this.pageContext.clear();
    this.pageContext.title = language.Generic.MenuFolders.kFSAStatistics + " / " + language.Generic.ServAdmin.kTitleUsermon;
    this.data = {
      activeSessions: [],
  ...
  _createClass(UserMonintorController, [{
    key: "loginStats",
    value: function loginStats() {
      this.$location.path("/userstat/");
    }
  }, {
    key: "errorsStats",
    value: function errorsStats() {
      this.$location.path("/userevents/");
    }
  }, {
    key: "sessionsMon",
    value: function sessionsMon() {
      this.$location.path("/sessionsmon/");
    }
  }, {
    key: "smsStats",
    value: function smsStats() {
      (0, _commonLegacy.DoSubmit)(document.forms["MenuForm"], '/asp/administration/smsstat.asp');
    }
  }, {
    key: "load",
    value: function load() {
      ...
      this.sessionsRepository.getActiveSessions().then(function (activeSessions) {
        _this2.data.activeSessions = activeSessions;
        _this2.data.selection.dropSelect();
        _this2.state.emptyData = !activeSessions.length;
  ...
  return UserMonintorController;
}();
var UserMonintorComponent = {
  controller: UserMonintorController,
  controllerAs: "$ctrl",
  templateUrl: "/static/dist/app/admin/stats/usermon/usermon.component.html"
};
exports.UserMonintorComponent = UserMonintorComponent;
...
exports.UserEventsRegistryComponent = void 0;
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var UserEventsRegistryController = /*#__PURE__*/_createClass(function UserEventsRegistryController(pageContext, language) {
  _classCallCheck(this, UserEventsRegistryController);
  this.language = language;
  pageContext.title = language.Generic.ServAdmin.kTitleErrorStat;
  pageContext.parent = {
    title: language.Generic.MenuFolders.kFSAStatistics,
    href: "/usermon/"
  };
  this.registryInfo = {
    url: "/webapi/admin/userevents/registry",
    filtersUrl: "/webapi/admin/userevents/registry/filter"
  };
});
var UserEventsRegistryComponent = {
  template: "<registry info=\"$ctrl.registryInfo\" controller=\"$ctrl.controller\"></registry>",
  controller: UserEventsRegistryController,
  controllerAs: "$ctrl"
};
exports.UserEventsRegistryComponent = UserEventsRegistryComponent;
...
exports.UserStatRegistryComponent = void 0;
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var UserStatRegistryController = /*#__PURE__*/_createClass(function UserStatRegistryController(pageContext, language) {
  _classCallCheck(this, UserStatRegistryController);
  this.language = language;
  pageContext.title = language.Generic.ServAdmin.kTitleUserStat;
  pageContext.parent = {
    title: language.Generic.MenuFolders.kFSAStatistics,
    href: "/usermon/"
  };
  this.registryInfo = {
    url: "/webapi/admin/userstat/registry",
    filtersUrl: "/webapi/admin/userstat/registry/filter",
    fieldDecorators: {
      "emNames": {
...
var UserStatRegistryComponent = {
  template: "<registry info=\"$ctrl.registryInfo\" controller=\"$ctrl.controller\"></registry>",
  controller: UserStatRegistryController,
  controllerAs: "$ctrl"
};
exports.UserStatRegistryComponent = UserStatRegistryComponent;
...
exports.SessionsMonitorRegistryComponent = void 0;
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var SessionsMonitorRegistryController = /*#__PURE__*/_createClass(function SessionsMonitorRegistryController(pageContext, language) {
  _classCallCheck(this, SessionsMonitorRegistryController);
  this.language = language;
  pageContext.title = "Монитор активных сессий";
  pageContext.parent = {
    title: language.Generic.MenuFolders.kFSAStatistics,
    href: "/usermon/"
  };
  this.registryInfo = {
    url: "/webapi/admin/sessions/monitor/registry",
    filtersUrl: "/webapi/admin/sessions/monitor/registry/filter",
    fieldDecorators: {
      "loginTime": new _registry.DateTimeDecorator(),
      "lastAccessTime": new _registry.DateTimeDecorator()
    }
  };
});
var SessionsMonitorRegistryComponent = {
  template: "<registry info=\"$ctrl.registryInfo\" controller=\"$ctrl.controller\"></registry>",
  controller: SessionsMonitorRegistryController,
  controllerAs: "$ctrl"
};
exports.SessionsMonitorRegistryComponent = SessionsMonitorRegistryComponent;
