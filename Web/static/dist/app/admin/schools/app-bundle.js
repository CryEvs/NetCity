...
var EditSchoolController = /*#__PURE__*/function (_NetCityModalControll) {
  ...
  _createClass(EditSchoolController, [{
    ...
    value: function loadCityRefs(cityId) {
      var _this2 = this;
      var cityPromises = [];
      // local deployment patch: "dummy" city id=0 (add without city in filter) -> /cities/0/districts fails with NullReferenceException
      var loadDistricts = (cityId > 0 ? this.addressRepository.getCityDistricts(cityId) : this.$q.resolve([])).then(function (districts) {
