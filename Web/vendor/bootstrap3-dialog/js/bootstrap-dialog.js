...
(function(root, factory) {
    ...
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v3.2'] = {
        hide: function(e) {
            ...
            if (openedDialogs.length === 0 && !$("[uib-modal-window]").length) {
    ...
    BootstrapDialogModal.METHODS_TO_OVERRIDE['v3.3'] = {
        ...
        setScrollbar: function() {
            ...
            if (this.bodyIsOverflowing) {
				...
				/*=======Milov======*/
            	/*hak IE 8-9*/
            	if (bowser.msie && (bowser.version == '8.0' || bowser.version == '9.0')) {
    ...
    BootstrapDialogModal.prototype.enforceFocus = function () { };
