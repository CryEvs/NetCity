...
function CalculateOSH() {
	SumRowAllColsByIndex(15, 1,3,4,[3,5,7]);
	SumRowAllColsByIndex(15, 2,3,4,[4,6,8]);
	
	ValidateIncludedRows(15, 3, [4], 3, 4);
	ValidateIncludedRows(15, 5, [6], 3, 4);
	ValidateIncludedRows(15, 7, [8], 3, 4);
	return true;
}
//--></script>
<%
