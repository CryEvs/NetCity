...
Sub AutoCalcEMInfo( )
	...
	Call GetSplitGEOSumValuesArrForEOTypes("T030103", "T030104", Array( _
		...
		GetFormParameter(sourceFormId, 4, 6, 4, Null)), arrEOTypes)
	...
	Call GetSplitGEOSumValuesArrForEOTypes("T030403", "T030404", Array( _
		GetFormParameter(sourceFormId, 4, 7, 4, Null), _
		GetFormParameter(sourceFormId, 4, 8, 4, Null), _
		GetFormParameter(sourceFormId, 4, 9, 4, Null), _
		GetFormParameter(sourceFormId, 4, 10, 4, Null), _
		GetFormParameter(sourceFormId, 4, 11, 4, Null)), arrEOTypes)
	...
	Call GetSplitGEOSumValuesArrForEOTypes("T030603", "T030604", Array( _
		GetFormParameter(sourceFormId, 4, 12, 4, Null), _
		GetFormParameter(sourceFormId, 4, 13, 4, Null), _
		GetFormParameter(sourceFormId, 4, 14, 4, Null)), arrEOTypes)
