...
Sub AutoCalcEMInfo( )
	...
	If Not IsMns() Then
		...
		Call GetSplitEOCountValues("T01.11803","T01.11804", sourceFormId, 8, 1, 3, Null, bFormSpec)
		Call GetSplitEOCountValues("T01.11903","T01.11904", sourceFormId, 7, 1, 3, Null, bFormSpec)
		Call GetSplitEOCountValues("T01.12003","T01.12004", sourceFormId, 7, 1, 5, Null, bFormSpec)
	End If
End Sub
%>
