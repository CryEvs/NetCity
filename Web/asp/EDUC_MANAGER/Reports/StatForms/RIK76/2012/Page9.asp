...
function CalculateOSH() {
	...
	SumColForRowRange(10, 7, 15, 15, [3, 5]);
	SumColForRowRange(10, 8, 15, 15, [4, 6]);
...
Sub AutoCalcEMInfo( )
	...
	If Not IsMns() Then
		Call GetEOSumValuesEx("T090103", StatForm_Osh1, 12, 1, 3, Null, bFormSpec)
	End If
	Call GetEOSumValues("T090203", StatForm_Osh1, 12, 2, 3, Null)
	Call GetEOSumValues("T090303", StatForm_Osh1, 12, 3, 3, Null)

	Call objSchoolFormComponent.CalcSplittedTableStatFormParameters(strEMID, strCommonYearID, , , , StatForm_Osh1, 14, 1, 8, 3, 6, objCityRes, objProvinceRes, bFormSpec)
	Call ClearForm
