...
<tr align="middle" valign="center">
	<td align="left">1-4 и подготовительные классы</td>
	<td>01</td>
...
<div align="left">по 11 классу в строке 07 в графах 3-5 раздела 3 – численность обучающихся, окончивших среднюю школу с аттестатом о среднем (полном) общем образовании, в строке 08 - число обучающихся, переведенных в 12 класс.</div>
<div align="left">Показатель по строке 20 заполняется <b>только</b> органами исполнительной власти субъектов Российской Федерации, на которые возложены функции по управлению учреждениями, реализующими программы общего образования.</div>
</td></tr></table>
