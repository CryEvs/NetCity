...
<tr align="middle" valign="center">
	...
	<td>из них (из графы 3)<br/>дети-инвалиды</td>
...
<tr align="middle" valign="center">
	<td align="left">Всего обучающихся индивидуально на дому(сумма строк 03,05)</td>
	<td>01</td>
	<%=DrawInputsWithTotals(1,3,5,15, Array(3,4,5))%>
</tr>
<tr align="middle" valign="center">
	<td align="left">&nbsp;&nbsp;&nbsp;из них (из стр.01) обучающихся с использованием дистанционных технологий<br/>(сумма строк 04,06)</td>
	<td>02</td>
	<%=DrawInputsWithTotals(2,3,5,15, Array(3,4,5))%>
</tr>
<tr align="middle" valign="center">
