...
<% dim i, istr, strYears
	...
	For I=2 To 19
	  ...
	  End If
%><tr align="center" valign="middle">
	<td><%=i+4%>&nbsp;<%=strYears%> <% If i=19 Then Response.Write "&nbsp;и<BR>старше" %></td>
...
<br/>
</table></td></tr><tr><td><div align="left">Численность обучающихся в специальных (коррек-<br />
	ционных) образовательных учреждениях и классах<br />для детей с ограниченными возможностями<br />здоровья в возрасте 16 лет и старше (чел) (21) <%=IT("T0521",4, 5 )%></div></td></tr>
