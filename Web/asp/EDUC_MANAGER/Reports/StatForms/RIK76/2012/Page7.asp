...
Sub AutoCalcEMInfo()
	...
	Call objSchoolFormComponent.CalcSplittedTableStatFormParameters(strEMID, strCommonYearID, Array(2,5,6,7,10,13), , Array(43, 44, 45), sourceFormId, 5, 1, 19, 3, 9, objCityRes, objProvinceRes, bFormSpec)
	Call ClearForm
