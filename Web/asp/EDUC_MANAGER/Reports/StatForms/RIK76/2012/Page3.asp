...
function CalculateOSH() {
	...
	SumRowAllColsByIndex('01.2', 24, 3, 3, [26, 28]);
	SumRowAllColsByIndex('01.2', 25, 3, 3, [27, 29]);
	...
	ValidateIncludedRows('01.2', 24, [30], 3, 3);
...
Sub AutoCalcEMInfo()
	...
	Call ClearForm
	Set objStudentsCount = objSchoolFormComponent.CalcStatFormParameterByFormAndSettlementType(strEMID, strCommonYearID, _
	GetFormParameter(StatForm_Osh1, 4, 15, 4, Null), bFormSpec)
...
Sub CalculateKRO(arrCounts)
	Dim nCityRes, nCityResAll, nProvinceRes, nProvinceResAll, nSumCityRes, nSumProvinceRes, i
	
	For i = 9 To 23 Step 2
		Call objSchoolFormComponent.CalcSplittedStatFormParameter(strEMID, strCommonYearID, , , StatForm_Osh1, 4, 15, i, Null, nCityResAll, nProvinceResAll, bFormSpec)
		Call objSchoolFormComponent.CalcSplittedStatFormParameter(strEMID, strCommonYearID, , Array(41,42,43,44,45), StatForm_Osh1, 4, 15, i, Null, nCityRes, nProvinceRes, bFormSpec)
