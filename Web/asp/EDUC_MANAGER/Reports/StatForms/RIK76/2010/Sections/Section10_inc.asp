...
%>
<tr><td><br /><div align="center"><b>Раздел 10. Кружковая работа обучающихся за <%=strShoolPrevYearStart%>/<%=strShoolPrevYearEnd%> учебный год</b></div><br></td></tr>
<tr><td><div align="right">Коды по ОКЕИ: единица - 642, человек - 792</div></td></tr>
<tr><td>
...
<tr align="middle" valign="center">
	...
	<%=DrawInputsWithTotals(2,3,8,10,Array(7,8))%>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	...
	<%=DrawInputsWithTotals(4,3,8,10,Array(7,8))%>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	...
	<%=DrawInputsWithTotals(6,3,8,10,Array(7,8))%>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	...
	<%=DrawInputsWithTotals(8,3,8,10,Array(7,8))%>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	...
	<%=DrawInputsWithTotals(10,3,8,10,Array(7,8))%>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	...
	<%=DrawInputsWithTotals(12,3,8,10,Array(7,8))%>
</tr>
<tr align="middle" valign="center">
