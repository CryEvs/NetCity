			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						...
						<br>
						влечет ответственность, установленную статьей 13.19 Кодекса Российской Федерации
						об административных правонарушениях<br>
						от 30.12.2001 № 195-ФЗ, а также статьей 3 Закона Российской Федерации от 13.05.92
						№ 2761-1 "Об ответственности за нарушение<br>
	...
	<tr>
		<td align="center">
			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<b>СВЕДЕНИЯ О ЧИСЛЕННОСТИ ДЕТЕЙ И ПОДРОСТКОВ В ВОЗРАСТЕ 7-18 ЛЕТ,<br />
							НЕ ОБУЧАЮЩИХСЯ В ОБРАЗОВАТЕЛЬНЫХ УЧРЕЖДЕНИЯХ</b><br />
	...
	<tr>
		<td align="center">
			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="left">
						<b>Наименование отчитывающейся организации </b>
					</td>
