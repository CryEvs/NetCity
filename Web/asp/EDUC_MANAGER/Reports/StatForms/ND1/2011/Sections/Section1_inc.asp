...
<table class="ThinTable" align="left" border="1" cellspacing="0" cellpadding="0"
	...
	<tr align="center" valign="middle">
		...
		<td colspan="12">
			Число полных лет на 1 января <%=strShoolYearEnd%> г.
		</td>
		<td rowspan="3">
			Итого не<br />
			обучающих-<br />
	...
	<tr align="center" valign="middle">
		<td align="left">
			Численность не обучающихся детей в образовательных<br />
			учреждениях - всего (сумма строк 05, 09, 13, 22, 28)
		</td>
		<td>
			01
		</td>
	...
	<tr align="center" valign="middle">
		<td align="left">
			из общей численности не обучающихся детей-беженцев и<br />
			вынужденных переселенцев<br />
			&nbsp;&nbsp;(из строки 01) *
		</td>
		<td>
			03
	...
	<tr align="center" valign="middle">
		<td align="left">
			Из общей численности не обучающихся детей в образовательных<br />
			учреждениях, по причинам:<br />
			&nbsp;&nbsp;&nbsp;болезни (из строки 01)
		</td>
		<td>
			05
		</td>
	...
	<tr align="center" valign="middle">
		<td align="left">
			Из общей численности не обучающихся в образовательных<br />
			учреждениях никогда не учились (кроме не подлежащих<br />
			обучению по состоянию здоровья) (из строки 01)
		</td>
		<td>
			09
		</td>
	...
	<tr align="center" valign="middle">
		<td align="left">
			...
			&nbsp;&nbsp;&nbsp;из 1-3 (4) классов, не окончив 3 (4) класс
		</td>
		<td>
			15
		</td>
	...
	<tr align="center" valign="middle">
		<td align="left">
			в том числе по причинам (из строки 13):<br />
	...
	<tr align="center" valign="middle">
		<td align="left">
			Выбыли из учреждений начального профессионального<br />
	...
	<tr align="center" valign="middle">
		<td align="left">
			Выбыли из учреждений среднего профессионального<br />
			образования и не продолжают обучение
		</td>
		<td>
			28
	...
	<tr align="center" valign="middle">
		<td align="left">
			&nbsp;в том числе по причинам (из строки 28):<br />
			&nbsp;&nbsp;материального положения родителей (законных представителей)
		</td>
		<td>
			30
...
<div align="left">
	...
	**В строке 13 учитываются обучающиеся всех видов образовательных учреждений, реализующих
	общеобразовательные программы, в том числе вечерних (сменных) школ, образовательных
	центров и комплексов и пр.
</div></td></tr></table>
<!--End Table 1-->
