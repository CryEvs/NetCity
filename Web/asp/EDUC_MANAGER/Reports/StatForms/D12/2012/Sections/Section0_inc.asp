...
%>
		...
		<tr><td align="center"><br>
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
			<TR><TD align="center">
			<B>СВЕДЕНИЯ ОБ ОБУЧАЮЩИХСЯ, ВЫБЫВШИХ ИЗ ОБЩЕОБРАЗОВАТЕЛЬНЫХ УЧРЕЖДЕНИЙ,<BR>РЕАЛИЗУЮЩИХ ПРОГРАММЫ ОБЩЕГО ОБРАЗОВАНИЯ</B><BR/>
            (без вечерних (сменных) общеобразовательных учреждений)<br/>в течение <%=strShoolPrevYearStart%>/<%=strShoolPrevYearEnd%> учебного года и летнего периода <%=strShoolPrevYearEnd%> года
			</td></tr>
			</table>
		</td></tr>
		<tr><td align="center"><br>
			...
			<tr><td>
				...
				<tr align="center">
					...
					<TD align="center" valign="top">25 октября<BR><BR><BR><BR>17 ноября<BR><BR><BR><BR><BR></TD>
				</tr>
				</table>
			</td><td>
			<table border="0" cellpadding="0" width="100%">
			<tr><td>
				<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
					<tr><td align="center">Форма № Д-12</td></tr></table>
			</td></tr>
