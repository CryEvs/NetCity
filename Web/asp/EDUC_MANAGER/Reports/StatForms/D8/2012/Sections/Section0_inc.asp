	...
	<tr>
		<td align="center">
			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<b>СВЕДЕНИЯ О ПРЕПОДАВАНИИ ИНОСТРАННЫХ ЯЗЫКОВ, УГЛУБЛЕННОМ ИЗУЧЕНИИ ОТДЕЛЬНЫХ ПРЕДМЕТОВ И<BR/>
							ПРОФИЛЬНОМ ОБУЧЕНИИ</b><br/>
						...
						<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="center" valign="top">
									29 октября<br><br><br><br>19 ноября
								</td>
							</tr>
						</table>
					</td>
