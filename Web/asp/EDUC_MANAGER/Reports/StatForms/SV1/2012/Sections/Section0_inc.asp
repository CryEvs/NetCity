...
%>
		...
		<tr><td align="center"><br>
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
			<TR><TD align="center">
			<B>СВЕДЕНИЯ О ВЕЧЕРНИХ (СМЕННЫХ ОБЩЕОБРАЗОВАТЕЛЬНЫХ УЧРЕЖДЕНИЯХ)</B><BR>
		...
		<tr><td align="center"><br>
			...
			<tr><td>
				...
				<tr align="center">
					...
					<TD align="center" valign="top">1 октября<BR><BR><BR><BR><BR><BR><BR>15 октября</TD>
				</tr>
				</table>
			</td><td>
			<table border="0" cellpadding="0" width="100%">
			<tr><td>
				<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
					<tr><td align="center">Форма № СВ-1</td></tr></table>
			</td></tr>
