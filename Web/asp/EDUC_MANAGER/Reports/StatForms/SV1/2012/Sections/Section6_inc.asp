...
<tr align="middle" valign="center">
	<td><%=CStr(CLng(strShoolYearEnd)-16)%> и<br>последующие<br>годы</td><td><%=CStr(CLng(strShoolYearEnd)-17)%>-<%=CStr(CLng(strShoolYearEnd)-18)%> г.г.</td><td><%=CStr(CLng(strShoolYearEnd)-19)%>-<%=CStr(CLng(strShoolYearEnd)-30)%> г.г.</td><td><%=CStr(CLng(strShoolYearEnd)-31)%> год и ранее</td>
</tr>
