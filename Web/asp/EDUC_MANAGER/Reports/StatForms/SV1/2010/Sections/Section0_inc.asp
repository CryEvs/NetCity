		...
		<tr><td align="center"><br><br><br>
			...
			<tr><td>
				...
				<tr align="center">
					...
					<TD align="center" valign="top">1 октября<BR><BR><BR><BR><BR><BR><BR><BR></TD>
				</tr>
				</table>
			...
			<tr><td align="center" valign="center" height="100%">
				Приказ Росстата:<br />Об утверждении формы<br />от  13.08.2008 № 187<br />О внесении изменений (при наличии)<br />
                от  __________ № ___<br />от  __________ № ___<BR><BR>
			</td></tr>
			<tr><td>
				<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
