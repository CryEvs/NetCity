...
<tr><td>
<br><br>
<div align="center">3. Число классов и в них обучающихся</div>
...
<tr align="center" valign="middle">
	...
	<td>04</td><%
		for i = 3 to 10
			if i=8 then
				response.write("<td align=""left""> "& ITS(GetFieldName(3, 4, i), 4, 5 ) & "</td>")
			else
...
<tr><td>
    ...
    <tr><td width="650">1) Из общей численности обучающихся 10 класса (гр.8, стр.04) (чел):<br>&nbsp;&nbsp;&nbsp;&nbsp;а) окончили основную дневную общеобразовательную школу в прошлом учебном году и ранее</td><td align"left"><br>(09)<%=IT("T030903",4,5)%></td></tr>
