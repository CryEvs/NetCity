	...
	<tr>
		<td>
			<table class="ThinTable" align="left" border="1" cellspacing="0" cellpadding="1"
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 05) детей, возвращенных родителям после проведения социально-реабилитационных <br />
						&emsp;мероприятий
					</td>
					<td>06</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 07) в связи с: жестоким обращением с детьми, в том числе из-за физического или <br />
						&emsp;психического насилия над ними, покушение на их половую неприкосновенность
					</td>
					<td>08</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;уклонением от выполнения обязанностей родителей, в том числе при злостном уклонении от уплаты<br/>
						&emsp;алиментов
					</td>
					<td>09</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;отказом без уважительных причин взять своего ребенка из родильного дома (отделения) либо из<br/>
						&emsp;иного лечебного учреждения, воспитательного учреждения, учреждения социальной защиты
						&emsp;населения или из аналогичных организаций
					</td>
					<td>10</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;злоупотреблением своими родительскими правами
					</td>
					<td>11</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;заболеванием хроническим алкоголизмом или наркоманией
					</td>
					<td>12</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;совершением умышленного преступления против жизни или здоровья своих детей либо против<br/>
						&emsp;жизни или здоровья супруга
					</td>
					<td>13</td>
					<%Call DrawInputs(5,13,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 14) вследствие:
						&emsp;их поведения
					</td>
					<td>15</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;психического расстройства или иного хронического заболевания
					</td>
					<td>16</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;стечения тяжелых обстоятельств
					</td>
					<td>17</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						...
						заключения (сумма строк 22-27)
					</td>
					<td>21</td>
					<%=DrawInputsWithTotals(21, 3, 3, 5, Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;в том числе (из стр. 21):<br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;численность детей, оставшихся без попечения родителей (из стр. 21)
					</td>
					<td>28</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						Число поступивших сообщений о нарушении прав детей, единиц
					</td>
					<td>29</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;из образовательных организаций
					</td>
					<td>32</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;из медицинских организаций
					</td>
					<td>33</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;из организаций социального обслуживания
					</td>
					<td>34</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;&emsp;из них (из стр. 36) от детей
					</td>
					<td>37</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						Число выявленных случаев жестокого обращения с детьми, единиц
					</td>
					<td>38</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 38) жестокого обращения с детьми-сиротами и детьми, оставшимися без попечения родителей
					</td>
					<td>39</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 40) привлеченных к уголовной ответственности за совершение<br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 42) по вине усыновителей
					<td>43</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;в том числе (из стр. 44):<br/>
						&emsp;&emsp;детей, оставшихся без попечения родителей, в возрасте от 14 до 18 лет
					</td>
					<td>45</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;лиц из числа детей, оставшихся без попечения родителей, в возрасте от 18 до 23 лет
					</td>
					<td>46</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;лиц в возрасте от 23 лет и старше
					</td>
					<td>47</td>
				...
				<tr align="middle" valign="center">
					...
					<td>48</td>
					<%Call DrawInputs(5,48,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;в том числе (из стр. 48)<br/>
						&emsp;&emsp;детей, оставшихся без попечения родителей, в возрасте от 14 до 18 лет
					</td>
					<td>49</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						...
						помещениями за отчетный год (сумма строк 53-55)
					</td>
					<td>52</td>
					<%=DrawInputsWithTotals(52, 3, 3, 5, Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 52)<br/>
						&emsp;&emsp;детей, оставшихся без попечения родителей, в возрасте от 14 до 18 лет
					</td>
					<td>53</td>
					<%Call DrawInputs(5,53,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;лиц из числа детей, оставшихся без попечения родителей, в возрасте от 18 до 23 лет
				...
				<tr align="middle" valign="center">
					...
					<td>55</td>
					<%Call DrawInputs(5,55,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;обеспеченных жилыми помещениями на основании вступивших в силу судебных решений
					</td>
					<td>56</td>
					<%Call DrawInputs(5,56,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Число семей, которым в течении отчетного года оказано содействие в предоставлении медицинской,<br />
						психологической, педагогической, юридической, социальной помощи, не относящейся к социальным<br />
						услугам (социальное сопровождение) в рамках законодательства Российской Федерации о социальном<br />
						обслуживании, единиц
					</td>
					<td>57</td>
					<%Call DrawInputs(5,57,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей, находящихся в замещающих семьях, имеющих право на получение алиментов
					</td>
					<td>58</td>
					<%Call DrawInputs(5,58,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 58) получают алименты
					</td>
					<td>59</td>
					<%Call DrawInputs(5,59,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Численность воспитанников организаций для детей-сирот, имеющих право на получение алиментов
					</td>
					<td>60</td>
					<%Call DrawInputs(5,60,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 60) получают алименты
					</td>
					<td>61</td>
					<%Call DrawInputs(5,61,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей-сирот и детей, оставшихся без попечения родителей, которым предоставлены путевки в<br>
						организации отдыха детей и их оздоровления, в санаторно-курортные организации
					</td>
					<td>62</td>
					<%Call DrawInputs(5,62,3,3)%>
				</tr>
			</table>
		</td>
	</tr>
