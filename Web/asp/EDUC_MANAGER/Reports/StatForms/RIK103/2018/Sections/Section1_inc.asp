	...
	<tr>
		<td>
			<table class="ThinTable" align="left" border="1" cellspacing="0" cellpadding="1"
				...
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей, оставленных родителями в организациях по окончании срока пребывания (из стр. 06)
					</td>
					<td>44</td>
					<%Call DrawInputs(1,44,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 44):<br>
						&emsp;&emsp;переданы в семью на воспитание на конец отчетного года
					</td>
					<td>45</td>
					<%Call DrawInputs(1,45,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;помещены под надзор в организации для детей-сирот и детей, оставшихся без попечения родителей<br>
					...
					<td>46</td>
					<%Call DrawInputs(1,46,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей, родители которых находятся под стражей или отбывают наказания в виде лишения свободы<br>
						(из стр. 06)
					</td>
					<td>47</td>
					<%Call DrawInputs(1,47,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 47):<br>
						&emsp;&emsp;переданы в семью на воспитание на конец отчетного года
					</td>
					<td>48</td>
					<%Call DrawInputs(1,48,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;помещены под надзор в организации для детей-сирот и детей, оставшихся без попечения родителей<br>
