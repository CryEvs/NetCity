	...
	<tr>
		<td>
			<table class="ThinTable" align="left" border="1" cellspacing="0" cellpadding="1"
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;поступили на обучение в образовательные учреждения начального, среднего и высшего<br />
				...
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей, которые находятся в бегах, учреждениях закрытого типа системы образования, учреждениях <br/>
						исполнения наказания и других учреждениях, не относящихся к организациям для детей-сирот и детей, оставшихся <br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей, оставшихся без попечения родителей, находящихся под надзором в организациях<br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						Численность детей, оставшихся без попечения родителей, поступивших на обучение<br/>
						в образовательные учреждения начального, среднего и высшего профессионального образования<br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 40) устроены
					</td>
					<td>41</td>
