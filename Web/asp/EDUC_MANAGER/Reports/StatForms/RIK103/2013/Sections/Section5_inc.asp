	...
	<tr>
		<td>
			<table class="ThinTable" align="left" border="1" cellspacing="0" cellpadding="1"
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 39) привлеченных к уголовной ответственности за совершение<br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 41) по вине усыновителей
					<td>42</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 43) детей, оставшихся без попечения родителей
					</td>
					<td>44</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;в том числе (из стр. 44) в возрасте:<br/>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 50) детей, оставшихся без попечения родителей
					</td>
					<td>51</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;в том числе (из стр. 51) в возрасте:<br/>
						&emsp;&emsp;&emsp;15 лет
					</td>
					<td>52</td>
					<%Call DrawInputs(5,52,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;&emsp;16 лет
				...
				<tr align="middle" valign="center">
					<td align="left">
						...
						помещениями за отчетный год (сумма строк 58-60)
					</td>
					<td>57</td>
					<%=DrawInputsWithTotals(57, 3, 3, 5, Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 57)<br/>
						&emsp;&emsp;детей, оставшихся без попечения родителей
					</td>
					<td>58</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;&emsp;лиц из числа детей, оставшихся без попечения родителей, в возрасте<br/>
						&emsp;&emsp;от 18 до 23 лет
					</td>
					<td>59</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						Число замещающих семей, которым оказываются услуги организациями, осуществляющими деятельность по <br />
						сопровождению замещающих семей
					</td>
					<td>62</td>
				...
				<tr align="middle" valign="center">
					<td align="left">
						Число детей, находящихся в семьях, имеющих право на получение алиментов, пособий и иных выплат
					</td>
					<td>63</td>
					<%Call DrawInputs(5,63,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 63) получают алименты
					</td>
					<td>64</td>
					<%Call DrawInputs(5,64,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Число воспитанников организаций детей-сирот, имеющих право на получение алиментов, пособий и иных выплат
					</td>
					<td>65</td>
					<%Call DrawInputs(5,65,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 65) получают алименты
					</td>
					<td>66</td>
					<%Call DrawInputs(5,66,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						Число детей, которым предоставлены путевки в организации отдыха и оздоровления детей
					</td>
					<td>67</td>
					<%Call DrawInputs(5,67,3,3)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&emsp;из них (из стр. 67) детей-сирот и детей, оставшихся без попечения родителей
					</td>
					<td>68</td>
					<%Call DrawInputs(5,68,3,3)%>
				</tr>
			</table>
		</td>
	</tr>
