...
Sub AutoCalcEMInfo()
	...
	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(11), , , sourceFormId, 1, 1, 2, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, True, 0)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(11), , , sourceFormId, 1, 7, 8, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, True, -4)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(11), , , sourceFormId, 1, 38, 40, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, True, -33)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(11), , , sourceFormId, 1, 41, 41, -1, -1, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, False, -33)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(11), , , sourceFormId, 1, 43, 44, -1, -1, objRes, True, bFormSpec)
...
Sub CommonProcessParams(objRS, bExistColumn, nRowDifference)
	...
	While Not objRS.EOF
		...
		If nValue > 0 Then
			strFieldName = GetFormFieldName("02.7", nRow, nCol)
...
Sub ClearForm()
	...
	For nCol = 3 to 30
		For nRow = 1 to 7
			Call SetLoadedRIKValue(GetFormFieldName("02.7", nRow, nCol), "")
		Next
	Next
	
	For nRow = 8 to 10
		Call SetLoadedRIKValue("T02.7" & nRow, "")
	Next
End Sub%>