...
Sub AutoCalcEMInfo()
	...
	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(7), , , sourceFormId, 1, 1, 2, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, 0)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(7), , , sourceFormId, 1, 7, 8, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, -4)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(7), , , sourceFormId, 1, 38, 38, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, -33)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(7), , , sourceFormId, 1, 40, 40, 3, 30, objRes, True, bFormSpec)
...
Sub CommonProcessParams(objRS, nRowDifference)
	...
	While Not objRS.EOF
		...
		If nValue > 0 Then
			strFieldName = GetFormFieldName("02.5", nRow, nCol)
...
Sub ClearForm()
	...
	For nCol = 3 to 30
		For nRow = 1 to 6
			Call SetLoadedRIKValue(GetFormFieldName("02.5", nRow, nCol), "")
		Next
	Next
End Sub%>