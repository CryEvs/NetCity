...
Sub AutoCalcEMInfo()
	...
	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(5), , , sourceFormId, 1, 1, 2, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, True, 0)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(5), , , sourceFormId, 1, 7, 8, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, True, -4)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(5), , , sourceFormId, 1, 36, 36, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, True, -31)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(5), , , sourceFormId, 1, 38, 40, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, True, -32)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(5), , , sourceFormId, 1, 41, 41, -1, -1, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, False, -32)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(5), , , sourceFormId, 1, 43, 44, -1, -1, objRes, False, bFormSpec)
...
Sub CommonProcessParams(objRS, bExistColumn, nRowDifference)
	...
	While Not objRS.EOF
		...
		If nValue > 0 Then
			strFieldName = GetFormFieldName("01.3", nRow, nCol)
...
Sub ClearForm()
	...
	For nCol = 3 to 30
		For nRow = 1 to 8
			Call SetLoadedRIKValue(GetFormFieldName("01.3", nRow, nCol), "")
		Next
	Next
	
	For nRow = 9 to 11
		Call SetLoadedRIKValue("T01.3" & nRow, "")
	Next
End Sub%>