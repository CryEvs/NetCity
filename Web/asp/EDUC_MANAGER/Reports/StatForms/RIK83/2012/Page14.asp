...
Sub AutoCalcEMInfo()
	...
	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(2), , , sourceFormId, 1, 1, 2, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, 0)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(2), , , sourceFormId, 1, 7, 8, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, -4)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(2), , , sourceFormId, 1, 36, 36, 3, 30, objRes, True, bFormSpec)
	Call CommonProcessParams(objRes, -31)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(2), , , sourceFormId, 1, 38, 40, 3, 30, objRes, True, bFormSpec)
...
Sub CommonProcessParams(objRS, nRowDifference)
	...
	While Not objRS.EOF
		...
		If nValue > 0 Then
			strFieldName = GetFormFieldName("02.2", nRow, nCol)
...
Sub ClearForm()
	...
	For nCol = 3 to 30
		For nRow = 1 to 8
			Call SetLoadedRIKValue(GetFormFieldName("02.2", nRow, nCol), "")
		Next
	Next
End Sub%>