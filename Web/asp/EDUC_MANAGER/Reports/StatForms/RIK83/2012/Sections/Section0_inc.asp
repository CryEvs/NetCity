	...
	<tr>
		<td align="center">
			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<b>СВЕДЕНИЯ О ЧИСЛЕННОСТИ И СОСТАВЕ РАБОТНИКОВ УЧРЕЖДЕНИЯ,<br>
						РЕАЛИЗУЮЩЕГО ПРОГРАММЫ ОБЩЕГО ОБРАЗОВАНИЯ<BR>
						(кроме вечерних (сменных) общеобразовательных учреждений)<br>
						по состоянию на 20 сентября <%=strShoolYearStart%> года<br/></b>
					</td>
				</tr>
			</table>
		</td>
				...
				<tr>
					<td>
						<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="left">
									орган местного самоуправления, осуществляющий управление в сфере образования, сводный отчет по<br>
									...
									орган исполнительной власти субъекта Российской Федерации, осуществляющий управление в сфере<br>
									образования, сводный отчет по субъекту Российской Федерации:<br>
									&nbsp;&nbsp;&nbsp;- Минобрнауки России
								</td>
								<td align="center" valign="top">
									15 октября<br><br><br><br>1 ноября
								</td>
							</tr>
						</table>
					</td>
