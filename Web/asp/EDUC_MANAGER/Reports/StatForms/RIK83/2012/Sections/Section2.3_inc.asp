...
<tr><td align="center">
	<b>2.3. Общеобразовательные учреждения</b>
	<br /><br />
...
<tr align="middle" valign="center">
  ...
  <td>08</td><%=DrawInputs(strSection, 8, 3, 30)%>
</tr>
</table>

<table class="filterTable">
				<tr>
					<td><br/><br/><b>Справка к разделу 2.3</b><br/></td>
				</tr>

				<tr>
					<td style="white-space: nowrap;">Численность медицинских работников<br/>(сумма строк 10, 11)(чел)<br/></td>
					<td>(09) <%=ITS("T02.309", 4, 5)%></td>
				</tr>

				<tr>
					<td>&nbsp;&nbsp;&nbsp;в том числе:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;врачи всех специальностей (чел)</td>
					<td>(10) <%=IT("T02.310", 4, 5 )%></td>
				</tr>

				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;медицинские сестры (чел)</td>
					<td>(11) <%=IT("T02.311", 4, 5)%></td>
				</tr>
			</table>
</td>
</tr>
