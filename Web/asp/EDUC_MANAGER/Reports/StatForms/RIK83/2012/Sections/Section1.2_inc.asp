...
<tr><td align="center">
	<b>1.2. Образовательные учреждения для детей дошкольного и младшего школьного возраста</b>
	<br /><br />
...
<tr align="middle" valign="center">
  <td  align="left" valign="middle" style="white-space: nowrap;">
	<b>Всего работников учреждений (сумма строк 02, 03, 06, 08)</b>
  </td>
  <td>01</td><%Call DrawSLine("01.2", 30, 1)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;в том числе:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;руководящие работники
  </td>
  <td>02</td><%=DrawInputs("01.2", 2, 3, 30)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;педагогические работники
  </td>
  <td>03</td><%=DrawInputs("01.2", 3, 3, 30)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;из них учителя
  </td>
  <td>04</td><%=DrawInputs("01.2", 4, 3, 30)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;из них (из стр. 03):<br/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;педагогический персонал, работающий в классах для<br/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;детей с ограниченными возможностями здоровья
  </td>
  <td>05</td><%=DrawInputs("01.2", 5, 3, 30)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;учебно-вспомогательный персонал
  </td>
  <td>06</td><%=DrawInputs("01.2", 6, 3, 30)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;из них (из стр. 03 и 06):<br/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;педагогический и учебно-вспомогательный персонал,<br/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;работающий с дошкольными группами
  </td>
  <td>07</td><%=DrawInputs("01.2", 7, 3, 30)%>
</tr>
<tr align="middle" valign="center">
  <td  align="left" valign="middle">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;обслуживающий персонал
  </td>
  <td>08</td><%=DrawInputs("01.2", 8, 3, 30)%>
</tr>
