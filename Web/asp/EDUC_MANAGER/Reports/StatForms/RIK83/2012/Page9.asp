...
Sub DrawPage()
	%>
	<!-- #INCLUDE FILE="Sections/Section1.8_inc.asp" -->
	<%
End Sub
...
Sub AutoCalcEMInfo()
	...
	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(10), , , sourceFormId, 1, 1, 2, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, 0)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(10), , , sourceFormId, 1, 7, 8, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, -4)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(10), , , sourceFormId, 1, 38, 38, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, -33)

	Call objSchoolFormComponent.CalcTableStatFormParametersFilterSettlementType(strEMID, strCommonYearID, Array(10), , , sourceFormId, 1, 40, 40, 3, 30, objRes, False, bFormSpec)
	Call CommonProcessParams(objRes, -34)
End Sub
...
Sub CommonProcessParams(objRS, nRowDifference)
	...
	While Not objRS.EOF
		...
		If nValue > 0 Then
			strFieldName = GetFormFieldName("01.8", nRow, nCol)
...
Sub ClearForm()
	...
	For nCol = 3 to 30
		For nRow = 1 to 6
			Call SetLoadedRIKValue(GetFormFieldName("01.8", nRow, nCol), "")
		Next
	Next
End Sub%>