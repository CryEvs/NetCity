...
<table class="print-block" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr align="center"><td><b>Раздел 4. Сведения об обучающихся детях-инвалидах</b></td></tr>
	<tr>
		<td align="center">
			<div align="right">
		...
		<td>
			<table class="ThinTable" align="left" border="1" cellspacing="0" cellpadding="1"
				...
				<tr align="center">
					...
					<td colspan="3">
						Численность обучающихся детей-инвалидов
					</td>
					<td colspan="3">
				...
				<tr align="middle" valign="center">
					...
					<td>02</td>
					<%Call DrawInputsWithTotals(2, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>03</td>
					<%Call DrawInputsWithTotals(3, 3, 8, 4, Array(3,4,5,6,7,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в начальных
					...
					<td>04</td>
					<%Call DrawInputsWithTotals(4, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в основных
					...
					<td>05</td>
					<%Call DrawInputsWithTotals(5, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в средних
					...
					<td>06</td>
					<%Call DrawInputsWithTotals(6, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>07</td>
					<%Call DrawInputsWithTotals(7, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>08</td>
					<%Call DrawInputsWithTotals(8, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в гимназиях
					...
					<td>09</td>
					<%Call DrawInputsWithTotals(9, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в лицеях
					...
					<td>10</td>
					<%Call DrawInputsWithTotals(10, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>11</td>
					<%Call DrawInputsWithTotals(11, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>12</td>
					<%Call DrawInputsWithTotals(12, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>13</td>
					<%Call DrawInputsWithTotals(13, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>14</td>
					<%Call DrawInputsWithTotals(14, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>15</td>
					<%Call DrawInputsWithTotals(15, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>16</td>
					<%Call DrawInputsWithTotals(16, 3, 8, 4, Array(5,8))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>17</td>
					<%Call DrawInputsWithTotals(17, 3, 8, 4, Array(5,8))%>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td align="left"><br/>
			&nbsp;&nbsp;&nbsp;* В строках 02 - 12, 15 - 17 показываются дети-инвалиды, обучающиеся в обычных классах, не являющихся специальными (коррекционными) классами.
		</td>
	</tr>
	<tr>
		<td>
