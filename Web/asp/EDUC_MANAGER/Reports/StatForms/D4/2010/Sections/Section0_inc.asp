...
%>
		...
		<tr><td align="center"><br><br><br>
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
			<TR><TD align="center">
			<B>СВЕДЕНИЯ О МАТЕРИАЛЬНОЙ БАЗЕ ДНЕВНЫХ ОБЩЕОБРАЗОВАТЕЛЬНЫХ УЧРЕЖДЕНИЙ</B><BR>
		...
		<tr><td align="center"><br><br><br>
			...
			<tr><td>
				...
				<tr align="center">
					...
					<TD align="center" valign="top">10 октября<BR><BR><BR><BR><BR><BR><BR>12 ноября</TD>
				</tr>
				</table>
			</td><td>
			<table border="0" cellpadding="0" width="100%">
			...
			<tr><td align="center" valign="center" height="100%">
					<BR>Утверждена<BR>постановлением<BR>Росстата<BR>от 10.07.2007 № 54<BR><BR>
			</td></tr>
			<tr><td>
				<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
					<tr><td align="center">1 раз в 2 года</td></tr></table>
			</td></tr>
			</table>
			</td></tr>
		</table>
