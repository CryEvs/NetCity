	...
	<tr>
		<td align="center">
			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<b>СВЕДЕНИЯ О РАСПРЕДЕЛЕНИИ УЧРЕЖДЕНИЙ, РЕАЛИЗУЮЩИХ ПРОГРАММЫ ОБЩЕГО ОБРАЗОВАНИЯ, <BR/>
							И ОБУЧАЮЩИХСЯ ПО ЯЗЫКУ ОБУЧЕНИЯ И ПО ИЗУЧЕНИЮ РОДНОГО (НЕРУССКОГО) ЯЗЫКА</b><BR/>
						...
						<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="center" valign="top">
									27 октября<br><br><br><br>17 ноября
								</td>
							</tr>
						</table>
					</td>
