	...
	<tr>
		<td align="center">
			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<b>СВЕДЕНИЯ О СПЕЦИАЛЬНЫХ (КОРРЕКЦИОННЫХ) ОБРАЗОВАТЕЛЬНЫХ УЧРЕЖДЕНИЯХ ДЛЯ ОБУЧАЮЩИХСЯ, ВОСПИТАННИКОВ<BR/>
							С ОГРАНИЧЕННЫМИ ВОЗМОЖНОСТЯМИ ЗДОРОВЬЯ И ОЗДОРОВИТЕЛЬНЫХ ОБРАЗОВАТЕЛЬНЫХ УЧРЕЖДЕНИЯХ САНАТОРНОГО<BR/>
							ТИПА ДЛЯ ДЕТЕЙ, НУЖДАЮЩИХСЯ В ДЛИТЕЛЬНОМ ЛЕЧЕНИИ</b><BR/>
						...
						<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="left">
									...
									сфере образования, сводныйотчет по субъекты Российской Федерации:<br />
									&nbsp;&nbsp;&nbsp;- Минобрнауки России<br />
								</td>
								<td align="center" valign="top">
									1 октября<br><br><br><br>15 октября
								</td>
							</tr>
						</table>
					</td>
