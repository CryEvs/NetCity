...
Dim nViewType
Dim arrStudentsNotFillingOnly, arrNotFillingSchoolsFinalReport
...
Sub specialRead()
	...
	Next
	Call obTokenMgr.SetData(strToken, "NotFillingStudentEMFields", nPersonalCardFields)
End Sub
...
Sub specialMain()
	...
	Set arrNotFillingSchoolsFinalReport = component.GetNotFillingBySchoolsFinalReport(nPersonalCardFields, nFuncType, nSchoolId, nGlobalYearId, nEmId, dtCurrentDate, nPdn, nNation)
	TestError obLanguage("EMReports","kCantGetNotFillingSchoolsFinalReport")
	If arrNotFillingSchoolsFinalReport.Count = 0 Then strErrMsg = obLanguage("EMReports","kEmptyNotFillingSchoolsFinalReport")
End Sub
...
Function GetReportTable()
	...
	For Each schoolInfo in arrNotFillingSchoolsFinalReport
		strBuilder.Append	"<tr>"
		...
		ElseIf schoolInfo.PlannedOccupancyAmount > 0 Then
