...
Sub specialHead()
	...
	<script>
		...
		$(document).ready(function() {
			jsSubmit({
				action: "/webapi/reports/studentsdata_fillingem",
				method: "GET",
				auth: false,
				showProcessing: true
				...
				fp = new filterPanel($(".filters-panel"), model, sources, "/webapi/reports/studentsdata_fillingem/initfilters", $("#buttonPanel"))
			});
		});
	</script><%
End Sub
