...
Sub specialHead()
	...
	<script>
		...
		$(document).ready(function() {
			...
			var fp = null;
			var reportId = "TalentStudentsEvents";
						...
						getTaskFunc: function() {
							return jsSubmit({
								...
								data: {	
									...
									params: [{name: "SCHOOLYEARID", value: appContext.yearId}, { name: "SERVERTIMEZONE", value: appContext.serverTimeZone }, { name: "FULLSCHOOLNAME", value: appContext.fullSchoolName }]
								},
