...
Sub specialWrite()
	WriteClass
	If strClassID <> "0" And strSubjClassID <> "0" Then
		WriteTerm
	End If
End Sub
...
Sub Main()
	...
	If objClassInfo.EOF Then
		Exit Sub
	End If
	strTeacherID = CStr(GetSafeLng(objClassInfo("TEACHERID"), Null))
End Sub
...
Sub specialFilters( strForm )
	...
	DrawTermsAndYearTotals strForm
	
	drawSimpleFilter "Reports","kSort", "", Array("kSortByLastName", "kSortByAverageMark")
	If bExit Then Exit Sub
...
Function hasNoStudents(ByVal theClassID)
	Dim oRs
	Set oRs = objNSNET.GetClassStudentListForTerm(strClassID, IIf(bYearTotal, -1, strTermID), True)
