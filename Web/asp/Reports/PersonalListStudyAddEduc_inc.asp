...
Sub specialMain()
	...
	If rsStudentList.EOF Then 
	    bOK = False 
	    strErrMsg = "Нет обучающихся в данном МОУ ДОД"
	End If    
	strReport = GetReport()
End Sub
...
Function GetReportTable()
	...
	Call GetArray()
	'Таблица Персональный список обучающихся в МОУ ДОД
	...
	For i = 1 To recCount
		EOF = rsRealClass.EOF
		strReport= strReport & "<tr align=""center""><td>" & i & "</td>"
		...
		"<td>" & countClass(rsStudentList("STUDENTID")) & "</td><td>" & strSchName & "</td><td>" & strClName & "</td><td>" & rsStudentList("FIO") & "</td><td ALIGN=""center"" class=""xd"">" & Date2Str(rsStudentList("BIRTHDATE")) & "</td><td>" & rsStudentList("DIRECTIONNAME") & "</td><td>" & rsStudentList("GRADE") & "</td><td>" & rsStudentList("CLASSSUBNAME") & "</td><td>" & DB2HTML(rsStudentList("SERTID"))  & "</td><td>" & DB2HTML(GetSafeLng(rsStudentList("WEEKHOURS"), 0)) & "</td></tr>"
	...
	For i = 0 To Ubound(classCount)
		strReport= strReport & "<tr align=""center""><td>" & i+1 & "</td><td>" & classCount(i) & "</td></tr>"
	Next
	strReport = strReport & "</table>"
...
Function GetTableHeaderByCountAssociation()
	GetTableHeaderByCountAssociation = "<table class=""ThinTable""  border=""1"" cellspacing=""0"">" & _
		"<tr class=""body"" style=""background-color: #eaeaea"" align=""center""><td colspan=""2"">" & obLanguage("Reports","kQuantity") &  "</td></tr>" & _
		"<tr class=""body"" style=""background-color: #eaeaea"" align=""center""><td>" & obLanguage("Reports","kAssociations") & "</td><td>" & obLanguage("Reports","kTrained") &  "</td></tr>"
End Function
