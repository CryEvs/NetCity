...
Function GetPageTitle()
	GetPageTitle = obLanguage("ReportNames","kCoverageAddEducationStudents", kFuncType_PreSchool)
End Function
...
Function GetTableHeader()
	GetTableHeader = "<table class=""table-print-num""><tr><th>№ п.п</th><th>" & obLanguage("Common","kGroupA") & "</th><th>" & obLanguage("Reports","kStudentsCount", kFuncType_PreSchool) & _
	"</th><th>" & obLanguage("Reports","kStudentsUdodCount", kFuncType_PreSchool) & "</th><th>" & obLanguage("Reports","kStudentsUdodPerc", kFuncType_PreSchool) & "</th></tr>"
End Function
