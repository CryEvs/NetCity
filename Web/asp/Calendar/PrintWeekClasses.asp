...
Sub onDrawPage()
	Response.Write GetPageTitlePrint( obLanguage("Calendar","kScheduleOn") & nWeekInYear & obLanguage("Calendar","kWeekFrom")&": "&obLanguage("Calendar","kFrom")&" " & Date2Str(BDate) &" "&obLanguage("Calendar","kTo")&" "& Date2Str(EDate), GetArrPageTitle())
	If Not bExit Then
