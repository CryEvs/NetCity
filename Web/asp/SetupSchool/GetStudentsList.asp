...
<!-- #INCLUDE VIRTUAL="/asp/SetupSchool/Informs/Informs_inc.asp" -->
...
Function LoadData()
	...
	Select Case nFindType
		...
		Case FilterType_Search
			...
			nCurrPage = 0
			pageCount = 1
			Set objStudentList = objNSNET.SearchUsers(2, strFio, strCurrYearID, strSchoolID, lngSortOrder, nInformFilterType, dtPayMonth)
		Case Else
...
Function GetData(objUserList)
	...
	If UseInformLoadMethod() Then
		properties = Array("id", "nickname", "firstname", "lastname", "middlename", "birthdate", "gender", IIf(bAddSchool, "rsClasses", "classname"), "homephone", "lastInformDate")
		columns = Array("STUDENTID", "NICKNAME", "FIRSTNAME", "LASTNAME", "MIDDLENAME", "BIRTHDATE", "GENDER", IIf(bAddSchool, "rsClasses", "CLASSNAME"), "HOMEPHONE", "LASTINFORMDATE")
	Else
		properties = Array("id", "nickname", "firstname", "lastname", "middlename", "birthdate", "gender", IIf(bAddSchool, "rsClasses", "classname"), "homephone")
		columns = Array("STUDENTID", "NICKNAME", "FIRSTNAME", "LASTNAME", "MIDDLENAME", "BIRTHDATE", "GENDER", IIf(bAddSchool, "rsClasses", "CLASSNAME"), "HOMEPHONE")
	End If
