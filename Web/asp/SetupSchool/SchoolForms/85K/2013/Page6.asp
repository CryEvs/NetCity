...
function CalculateOSH()
{
	...
	ValidateDividedCols('02.5', 3, [4], 2, 9);
	return true;
}
...
Sub AutoCalc()
	...
	Set allChildren = objNSNET.Get85KSection26AllChildren(strSchoolYearID)
	Call SetLoadedOSHValue("T02.60204", allChildren("allChildren").Value)
End Sub
%>