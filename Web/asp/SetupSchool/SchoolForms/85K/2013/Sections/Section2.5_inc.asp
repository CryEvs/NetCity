...
<tr><td>
<div align="center" style="margin-top:20px; margin-bottom:10px;"><b>2.5. Число случаев заболевания детей</b></div>
...
<tr align="middle" valign="center">
	<td align="left">&nbsp;&nbsp;&nbsp;энтериты, колиты и гастроэнтериты, вызванные<br>&nbsp;&nbsp;&nbsp;установленными, не установленными и<br>&nbsp;&nbsp;&nbsp;неточно обозначенными возбудителями</td>
	<td>03</td>
...
<tr><td><br/>
Среднегодовая численность детей за период с начала отчетного года (10)&nbsp;&nbsp; <%=IT(GetFieldName("02.5",10,3),4, 5 )%>&nbsp;&nbsp;(код по ОКЕИ: человек - 792)
</td></tr>
