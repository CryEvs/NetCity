...
<tr align="middle" valign="center" rowspan="2">
	...
	<td colspan="3">Численность детей, человек</td>
...
<tr align="middle" valign="center">
	...
	<tr align="middle" valign="center">
			<td>в группах для детей в<br>возрасте 3 года и<br>старше</td>
...
<tr align="middle" valign="center">
	<td align="left">Всего <br />(сумма строк 02, 11, 12, 15, 16, 17)</td>
	<td>01</td><%=DrawInputsWithTotals(1, 3, 8, "02.1", Array(3, 4, 5, 6, 7, 7))%>
</tr>
<tr align="middle" valign="center">
	<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;в том числе:<br>
	&nbsp;&nbsp;&nbsp;группы компенсирующей направленности </td>
	<td>02</td>
	<%=DrawInputsWithTotals(2, 3, 8, "02.1", Array(3, 4, 5, 6, 7, 7))%>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	<td align="left">&nbsp;&nbsp;&nbsp;группы по присмотру и уходу за детьми
	<td>16</td>
...
<tr align="middle" valign="center">
	...
	<td>22</td>
	<%=DrawInputs("02.1", 22 , 3, 3)%><td>X</td><td>X</td><td>X</td><td>X</td><td>X</td>
</tr>
<tr align="middle" valign="center">
	<td align="left">&nbsp;&nbsp;&nbsp;разновозрастные группы
	<td>23</td>
	<%=DrawInputs("02.1", 23 , 3, 3)%><td>X</td><td>X</td><%=DrawInputs("02.1", 23 , 6, 6)%><td>X</td><td>X</td>
</tr>
</table>
