...
<tr><td>
<div align="center" style="margin:10px;"><b>Раздел 4. Материально-техническая база организации</b></div>
...
<tr align="middle" valign="top" rowspan="2">
	...
	<td rowspan="2">Общая площадь<br/>зданий и<br/>помещений<br/>(сумма гр.4-8)</td>
...
&nbsp;&nbsp;&nbsp;Дошкольная образовательная организация имеет (укажите соответствующий код: да - 1, нет - 0): музыкальный зал (07)&nbsp;<%=IB2("T04.10703")%>&nbsp;, физкультурный зал (08)&nbsp;<%=IB2("T04.10803")%>&nbsp;,<br />
&nbsp;&nbsp;&nbsp;закрытый плавательный бассейн (09)&nbsp;<%=IB2("T04.10903")%>&nbsp;, зимний сад (10)&nbsp;<%=IB2("T04.11003")%>&nbsp;.
</td></tr></table>