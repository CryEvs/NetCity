...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;из них:<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;находятся в аварийном состоянии (08)&nbsp;<%=IT("T04.20803", 4, 5 )%><br /><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;требуют капитального ремонта (09)&nbsp;<%=IT("T04.20903", 4, 5 )%><br /><br />

&nbsp;&nbsp;&nbsp;Число персональных компьютеров (10)&nbsp;<%=IT("T04.21003", 4, 5 )%><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;из них доступны для использования детьми (11)&nbsp;<%=IT("T04.21103", 4, 5 )%><br /><br />
&nbsp;&nbsp;&nbsp;Число компьютеров, имеющих доступ к сети Интернет (12)&nbsp;<%=IT("T04.21203", 4, 5 )%><br />
&nbsp;&nbsp;&nbsp;Наличие адреса электронной почты (укажите соответсвующий код: да - 1; нет - 0) (13)&nbsp;<%=IB0("T04.21303")%> <br /><br />
&nbsp;&nbsp;&nbsp;Дошкольная образовательная организация (укажите соответсвующий код: да - 1; нет - 0):<br /><br />
&nbsp;&nbsp;&nbsp;имеет собственный сайт в сети Интернет (14)&nbsp;<%=IB0("T04.21403")%>,<br />
&nbsp;&nbsp;&nbsp;предоставляет на своем сайте нормативно закрепленный перечень сведений о своей деятельности (15)&nbsp;<%=IB0("T04.21503")%>.
</td></tr>