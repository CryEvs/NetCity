...
{
	SumRowAllCols('02.1', 2, 3, 8, 3, 10);
	SumRowAllColsByIndex('02.1', 1, 3, 8, [2, 11, 12, 15, 16, 17, 18]);

	ValidateDividedCols('02.1', 3, [4,5], 1, 18);
	ValidateIncludedCols('02.1', 6, [7], 1, 18);
	ValidateIncludedRows('02.1', 12, [13,14], 3, 7);

	ValidateIncludedCells('02.1', 1, 3, [19], 3);
	ValidateIncludedCells('02.1', 1, 3, [20], 3);
	ValidateIncludedCells('02.1', 1, 3, [21], 3);
	ValidateIncludedCells('02.1', 1, 6, [19], 6);
	ValidateIncludedCells('02.1', 1, 6, [20], 6);
...
Sub AutoCalc()
	...
	Call SetLoadedOSHValue("T02.11903", objCountDevCom("PUPILCOUNT"))

	' Заполнение гр.3 стр. 20
	...
	Call SetLoadedOSHValue("T02.12003", objCountDevCom("PUPILCOUNT"))
