...
Sub AutoCalc()
	...
	Set objCountPupil = objNSNET.Get85KSection22CountPupil("Ж", strSchoolYearID, dtOnDate, 1026, 3, 10, False)
	Call FillDistribStudentsByAge(objCountPupil, 3)

	'Раздел 2.3
	FillAttendanceFromParentPay
	'Call FillAttendance("T02.30103", Empty, Empty, False)
	'Call FillAttendance("T02.30104", "4, 5, 6, 7, 8", Empty, false)
	'Call FillAttendance("T02.30303", Empty, "УП", false)
	'Call FillAttendance("T02.30304", "4, 5, 6, 7, 8", "УП", false)
	'Call FillAttendance("T02.30403", Empty, "УП", true)
	'Call FillAttendance("T02.30404", "4, 5, 6, 7, 8", "УП", true)
End Sub
