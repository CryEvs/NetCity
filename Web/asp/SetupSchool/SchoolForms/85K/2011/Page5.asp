...
function CalculateOSH()
{
	...
	SumColAllRows('02.2', 3, 2, 3, 4, 11);
	SumColAllRows('02.2', 3, 4, 5, 8, 11);
...
Sub AutoCalc()
	...
	For i = 1 To 2
		...
		next
	next
	Set objCountPupil = objNSNET.Get85KSection22CountPupil(Empty, strSchoolYearID, dtPresentationDate, -1, -1, 7, False)
	...
	nDtPresentationDate = DateSerial(2013, 1, 1)
	...
	Do While Not objCountPupil.Eof
		...
		objCountPupil.MoveNext
	Loop
	Set objCountPupil = objNSNET.Get85KSection22CountPupil("Ж", strSchoolYearID, dtPresentationDate, -1, -1, 7, False)
	Do While Not objCountPupil.Eof
	...
	sum = 0
	Set objCountPupil = objNSNET.Get85KSection22CountPupil(Empty, strSchoolYearID, nDtPresentationDate, 1026, 3, 7, False)
	Do While Not objCountPupil.Eof
