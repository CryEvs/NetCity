...
Sub AutoCalc( )
	...
	Set objChildTypeDisabilityInfo = objNSNET.GetOSH1ChildTypeDisabilityInfo(strCurrYearID, startDate, true, bIsMNS)
	Set objChildInvalidInfo = objNSNET.GetOSH1ChildInvalidInfo(strCurrYearID, startDate, true, bIsMNS)
