...
<tr align="middle" valign="center">
	<td align="left">Численность детей-сирот и детей, оставшихся без попечения родителей (устроенные под надзор в образовательных организациях) (чел)</td><td>17</td><td><%=IT("T041703", 10, 10 )%></td>
</tr>
<tr align="middle" valign="center">
	<td align="left">Численность детей с умственной отсталостью (заполняет специальное (коррекционное) учреждение для детей с ограниченными возможностями здоровья) (чел)</td><td>18</td><td><%=IT("T041803", 10, 10 )%></td>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	<td align="left">Численность обучающихся на дому по индивидуальным учебным планам (чел)</td><td>24</td><td><%=IT("T042403", 10, 10 )%></td>
</tr>
<tr align="middle" valign="center">
...
<tr align="middle" valign="center">
	<td align="left">Численность обучающихся, воспитанников с ограниченными возможностями здоровья в обычных классах* (чел)</td><td>27</td><td><%=IT("T042703", 10, 10 )%></td>
</tr>
<tr align="middle" valign="center">
	<td align="left">Численность детей-инвалидов (чел)</td><td>28</td><td><%=IT("T042803", 10, 10 )%></td>
</tr>
<tr align="middle" valign="center">
	<td align="left">Численность детей, обучающихся в форме семейного образования</td><td>29</td><td><%=IT("T042903", 10, 10 )%></td>
</tr>
<tr align="middle" valign="center">
