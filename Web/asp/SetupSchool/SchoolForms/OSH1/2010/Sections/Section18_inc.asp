...
,"Другие"_
,"Кроме того, индивидуальные образовательные программы<br >профильного обучения"_
)
...
<tr align="center" valign="middle">
	...
	for i = 2 to 3
		istr = CStr( i )
		istr = "0" & istr
		response.write("<td>" & IIF(j>1,IIF(i=2, ITDisabled(strID & istr, IIF(i=2,2,5), IIF(i=3,3,5), bIsMNS), IT(strID & istr, IIF(i=2,2,5), IIF(i=3,3,5))),ITS(strID & istr, IIF(i=2,2,5), IIF(i=2,3,10))) &  "</td>")
	next
	%>
</tr><%
Next%>
