...
<tr><td>
	<div align="left">
		Численность обучающихся в специальных (коррекционных) классах для детей с ограниченными возможностями здоровья в возрасте 16 лет и старше (чел)<%=IT("T0521", 10, 10 )%>
	</div>
</td></tr>
<!-- end of таб.5 -->
