...
<tr><td>
	<div align="left">
		Численность обучающихся в специальных (коррекционных) классах для детей с ограниченными возможностями здоровья в возрасте 16 лет и старше (чел) (21) <%=IT("T052103", 10, 10 )%>
	</div>
</td></tr>
<!-- end of таб.5 -->
