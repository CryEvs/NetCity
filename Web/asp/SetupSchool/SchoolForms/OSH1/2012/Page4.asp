...
Sub AutoCalc( )
	...
	Call ClearAvtoCalcFields("T05",21,21,3,3)
	...
	Do While Not objSeniorStudentsAgeInfo.EoF
		...
		'If nAge >= kMinSeniorAge Then - это ограничение не понятно???
		If nAge >= kMinAge Then
			If nAge > kMaxAge Then nAge = kMaxAge
	...
	TestError( kStudentsAgeInfoUnavalable )
	Call SetLoadedOSHValue( "T052103",objStudentsAgeInfo("STUDENTSCOUNT"))
	...
	End If
	Call SetLoadedOSHValue( "T070104", GetSafeLng(objRelaysClassesStudentsCnt("RELAY2"), 0) )
	If Not bIsMNS Then
		Call SetLoadedOSHValue( "T070105", objRelaysClassesCnt("RELAY3") )
	End If
	Call SetLoadedOSHValue( "T070106", GetSafeLng(objRelaysClassesStudentsCnt("RELAY3"), 0))
End Sub
%>
