...
Sub AutoCalc( )
	...
	Set objChildTypeDisabilityInfo = objNSNET.GetOSH1ChildTypeDisabilityInfo(strCurrYearID, dtPresentationDate, false, bIsMNS)
	Set objChildInvalidInfo = objNSNET.GetOSH1ChildInvalidInfo(strCurrYearID, dtPresentationDate, false, bIsMNS)
