...
Sub AutoCalc( )
	...
	Set nGraduateSKOCount = objNSNET.GetOSH1_GraduateFromSKOCount(strCurrYearID, kClassType_SKO, bIsMNS)
	TestError(kAwardsInfoUnavalable)
	Call SetLoadedOSHValue( "T023003", GetSafeLng(nGraduateSKOCount("STUDENTSCOUNT"), 0) )
End Sub
