...
Sub AutoCalc( )
	...
	If Not objClassInfo.EoF and Not bIsMNS Then
		nClasses = GetSafeLng( objClassInfo("CLASSESCOUNT"), 0 )
		Call SetLoadedOSHValue( "T030503", nClasses )
	End If
	...
	If Not bIsMNS Then
		...
		Loop
		Call SetLoadedOSHValue( "T030103", nMinorClasses )
		Call SetLoadedOSHValue( "T030203", n5_9Classes )
		Call SetLoadedOSHValue( "T030303", n10_11Classes )
	End If
	...
	If Not bIsMNS Then
		...
		'Call SetLoadedOSHValue( "T040303", objGradeInfo("CLASSESCOUNT") )
	...
	'Call SetLoadedOSHValue( "T040304", objClassStudentsInfo("STUDENTSCOUNT"))
	'Call SetLoadedOSHValue( "T040307", objClassStudentsInfo("GIRLSCOUNT"))
	...
	Loop
	'Set objCountStudentsStay = objNSNET.GetCountStudPreSchoolInGradeByDocTypeOnDateInPrevYear(strCurrYearID, NetCity_Common_Enums_EoType_PreSchool, kDocType_STAY, dtPresentationDate, 1, 1, bIsMNS)
	'Call SetLoadedOSHValue( "T040306", objCountStudentsStay("CNT_STUD") )
