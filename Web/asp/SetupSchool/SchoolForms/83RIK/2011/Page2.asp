...
Sub SpecialOnHead()
	...
	<script> <!--
		...
		function CalculateOSH() {
			...
			for (var i = 3; i <= 30; i++) {
				var totalRowValue = GetParamaterValue(1, 7, i) + GetParamaterValue(1, 38, i);
				var paramValue = GetParamaterValue(1, 39, i);
				if (paramValue > totalRowValue) {
					var elemName1 = GetParameterName(1, 7, i);
					var elemName2 = GetParameterName(1, 38, i);
					var elem1 = $('input[name="' + elemName1 + '"]');
					var elem2 = $('input[name="' + elemName2 + '"]');
					elem1.addClass('form-cell-invalid');
					elem2.addClass('form-cell-invalid');
					bIsDataValid = false;
				}
			}
