...
%>
		...
		<tr><td align="center"><br><br>
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
			<tr><td align="center">
			СВЕДЕНИЯ ОБ УЧРЕЖДЕНИИ ДОПОЛНИТЕЛЬНОГО ОБРАЗОВАНИЯ ДЕТЕЙ<br />
		...
		<tr><td align="center"><br><br><br>
			...
			<tr><td>
				...
				<tr align="center">
					...
					<td align="left" valign="top">
						юридические лица - учреждения дополнительного образования детей:<br/>
						&nbsp;&nbsp;&nbsp;- органу местного самоуправления,<br>
						&nbsp;&nbsp;&nbsp;органу исполнительной власти субъекта Российской Федерации,<br/> 
						&nbsp;&nbsp;&nbsp;федеральному органу исполнительной власти, на которые возложены функции<br>
						&nbsp;&nbsp;&nbsp;по управлению учреждениями, реализующими программы<br>
						&nbsp;&nbsp;&nbsp;дополнительного образования детей (по принадлежности)
					</td>
					<td align="center" valign="top">25 января<br /><br /><br /><br /><br /><br /></td>
				</tr>
				</table>
			</td>
			<TD width="4%" >&nbsp;</TD>
			...
			<tr><td>
				<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
					<tr><td align="center"><b>Форма № 1-ДО</b></td></tr></table>
			</td></tr>
	...
	<tr><td align="center"><br><br><br>
		...
		<TR>
			...
			<TD COLSPAN="<%=colCount%>"><b>Почтовый адрес</b><%=replace(lPad(0, 33),"0","&nbsp;")%><%=GetSafeStrParam(objSchoolParams("Address"), "")%></b></TD>
		</TR><TR align="center">
