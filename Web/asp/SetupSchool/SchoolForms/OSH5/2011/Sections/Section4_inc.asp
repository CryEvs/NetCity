...
<table align="left" cellpadding="2" width="48%">
    <tr>
        <td align="left">
            <br>
            <br>
            Численность обучающихся, получивших аттестат об основном общем образовании
        </td>
        <td align="center">
            (02)
        </td>
    ...
    <tr>
        <td align="left">
            ...
            <br>
            образовании в порядке экстерната или из выпуска прошлых лет
        </td>
        <td align="center">
            (03)
        </td>
    ...
    <tr>
        <td align="left">
            ...
            общем образовании в порядке экстерната
        </td>
        <td align="center">
            (05)
        </td>
    ...
    <tr>
        <td align="left">
            Кроме того, численность выпускного класса, не получивших аттестат о<br>
    ...
    <tr>
        <td align="left">
            Численность выпускников, допущенных к выпускным экзаменам
        </td>
        <td align="center">
            (07)
        </td>
    ...
    <tr>
        <td align="left">
            &nbsp;из них (из стр.07) участвовавшие в едином государственном экзамене (ЕГЭ)
        </td>
        <td align="center">
            (08)
        </td>
    ...
    <tr>
        <td align="left">
            &nbsp;&nbsp;численность выпускников, участвовавших в ЕГЭ по русскому языку
        </td>
        <td align="center">
            (09)
        </td>
    ...
    <tr>
        <td align="left">
            &nbsp;&nbsp;численность выпускников, участвовавших в ЕГЭ по математике
        </td>
        <td align="center">
            (11)
        </td>
    ...
    <tr>
        <td align="left">
            ...
            <br>
            &nbsp;награждены золотой медалью "За особые успехи в учении"
        </td>
        <td align="center">
            (13)
        </td>
    ...
    <tr>
        <td align="left">
            &nbsp;награждены серебряной медалью "За особые успехи в учении"
        </td>
        <td align="center">
            (14)
        </td>
