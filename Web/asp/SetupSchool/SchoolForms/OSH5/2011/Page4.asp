...
<script> <!--
    ...
    function CalculateOSH() {
        ValidateIncludedRows(4, 7, [8], 3, 3);
        ValidateIncludedRows(4, 9, [10], 3, 3);
        ValidateIncludedRows(4, 11, [12], 3, 3);
        ValidateIncludedRows(5, 1, [2], 3, 7);
        SumCol(5, 3, [1, 2, 3], 4, 7);
        ValidateCell(5, 1, 3, [4], 3);
        return true;
    }
//--></script>
<%
...
Sub AutoCalc()
	...
	' Page 4 Table 4
	Set objYearAndGraduateInfo = objNSNET.GetOSH1YearAndGraduateInfo(strCurrYearID, False )
	...
	Set objAwardsInfo = objNSNET.GetOSH1AwardsInfo(strCurrYearID, False )
	...
	Do While Not objAwardsInfo.EoF
		...
		If nAwardType = kAwardType_Silver Then
			...
			Call SetLoadedOSHValue( "T0414", nStudents )
		Elseif nAwardType = kAwardType_Gold Then
			nGraduateSecondary = nGraduateSecondary + nStudents
			Call SetLoadedOSHValue( "T0413", nStudents )
		Elseif nAwardType = kAwardType_General Then
			Call SetLoadedOSHValue( "T0402", nStudents )
	...
	Loop
	Call SetLoadedOSHValue( "T0404", nGraduateSecondary )

	' Page 4 Table 5
	Set objStudentsAgeInfo = objNSNET.GetOSH5StudentsAgeInfo(strCurrYearID, dtOnDate )
	...
	Call SetLoadedOSHValue( "T050403", nGirlsTotal )

	Set objSeniorStudentsAgeInfo = objNSNET.GetOSH1SeniorStudentsAgeInfo(strCurrYearID, dtPresentationDate, False )
