			...
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						...
						ДЕЯТЕЛЬНОСТЬ ПО ДОПОЛНИТЕЛЬНЫМ ОБЩЕОБРАЗОВАТЕЛЬНЫМ ПРОГРАММАМ ДЛЯ ДЕТЕЙ<br />
						...
						<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="left" valign="top">
									юридические лица, осуществляющие образовательную деятельность по<br /> дополнительным общеобразовательным программам для детей:<br />
									&nbsp;&nbsp;&nbsp;-&nbsp;территориальному органу Росстата в субъекте Российской Федерации<br /> 
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;по установленному им адресу
								</td>
								<td align="center" valign="top">
									5 февраля<br/>после отчетного периода
									<br><br><br><br><br><br>
								</td>
							</tr>
						</table>
						...
						<table border="0" cellpadding="0" width="100%">
							<tr>
								<td>
									<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
										<tr>
											<td align="center">Форма № 1-ДОП</td>
										</tr>
									</table>
								</td>
							</tr>
