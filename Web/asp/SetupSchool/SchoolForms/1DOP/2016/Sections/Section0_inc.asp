	...
	<tr>
		<td align="center"><br><br>
			<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						 СВЕДЕНИЯ О ДОПОЛНИТЕЛЬНОМ ОБРАЗОВАНИИ И СПОРТИВНОЙ ПОДГОТОВКЕ ДЕТЕЙ<br />
						...
						<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="left" valign="top">
									&nbsp;юридические лица, осуществляющие образовательную деятельность по дополнительным <br>
									&nbsp;общеобразовательным программам для детей на основании соответствующей лицензии, <br>
									&nbsp;и/или реализующие программы спортивной подготовки:<br>
									&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;территориальному органу Росстата в субъекте Российской Федерации<br /> 
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;по установленному им адресу
								</td>
								<td align="center" valign="top">
									5 февраля после отчетного периода
									<br><br><br><br><br><br>
								</td>
							</tr>
						</table>
						...
						<table border="0" cellpadding="0" width="100%">
							<tr>
								<td>
									<table class="ThinTable" border="1" cellpadding="3" cellspacing="0" width="100%">
										<tr>
											<td align="center"><b>Форма № 1-ДОП</b></td>
										</tr>
									</table>
								</td>
							</tr>
