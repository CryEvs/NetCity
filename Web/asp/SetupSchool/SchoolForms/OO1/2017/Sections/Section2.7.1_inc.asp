<table class="print-block" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<div align="center"><b>2.7.1. Численность обучающихся по источникам финансирования их обучения</b></div>
			...
			<table class="ThinTable" align="left" border="1" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr align="middle" valign="center">
					...
					<td>05</td>
					<%=DrawInputs("02.7.1", 5, 3, 9)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;иных физических лиц</td>
					<td>06</td>
					<%=DrawInputs("02.7.1", 6, 3, 9)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;юридических лиц</td>
					<td>07</td>
					<%=DrawInputs("02.7.1", 7, 3, 9)%>
				</tr>
			</table>
		</td>
	</tr>
