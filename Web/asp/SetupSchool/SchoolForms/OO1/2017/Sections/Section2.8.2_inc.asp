<table class="print-block" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<div align="center"><b>2.8.2. Выбытие обучающихся.</b></div>
			...
			<table class="ThinTable" align="left" border="1" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr align="middle" valign="center">
					...
					<td>01</td>
					<%=DrawInputsWithTotals(1, 3, 11, "02.8.2", Array(3,4,5,6,7,8,9,10,11))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;в том числе:<br>
					...
					<td>02</td>
					<%=DrawInputsWithTotals(2, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;из них (из стр. 02):<br>
					...
					<td>03</td>
					<%=DrawInputsWithTotals(3, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>04</td>
					<%=DrawInputsWithTotals(4, 3, 6, "02.8.2", Array(3))%>
					<td>x</td>
					<td>x</td>
					<td>x</td>
					<td>x</td>
					<%=DrawInputs("02.8.2", 4, 11, 11)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>05</td>
					<%=DrawInputsWithTotals(5, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>06</td>
					<%=DrawInputsWithTotals(6, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;из всех классов, кроме классов для обучающихся с ограниченными<br>
					...
					<td>07</td>
					<%=DrawInputsWithTotals(7, 3, 6, "02.8.2", Array(3))%>
					<td>x</td>
					<td>x</td>
					<td>x</td>
					<td>x</td>
					<%=DrawInputs("02.8.2", 7, 11, 11)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>08</td>
					<%=DrawInputsWithTotals(8, 3, 6, "02.8.2", Array(3))%>
					<td>x</td>
					<td>x</td>
					<%=DrawInputs("02.8.2", 8, 9, 9)%>
					<td>x</td>
					<%=DrawInputs("02.8.2", 8, 11, 11)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						на обучение по программам среднего профессионального образования -<br>
					...
					<td>09</td>
					<%=DrawInputsWithTotals(9, 3, 3, "02.8.2", Array(3))%>
					<td>x</td>
					<%=DrawInputs("02.8.2", 9, 5, 6)%>
					<td>x</td>
					<td>x</td>
					<%=DrawInputs("02.8.2", 9, 9, 9)%>
					<td>x</td>
					<%=DrawInputs("02.8.2", 9, 11, 11)%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">в связи с переходом на семейное образование и самообразование</td>
					<td>10</td>
					<%=DrawInputsWithTotals(10, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">по болезни</td>
					<td>11</td>
					<%=DrawInputsWithTotals(11, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>12</td>
					<%=DrawInputsWithTotals(12, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">выбыло по другим причинам</td>
					<td>13</td>
					<%=DrawInputsWithTotals(13, 3, 11, "02.8.2", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
