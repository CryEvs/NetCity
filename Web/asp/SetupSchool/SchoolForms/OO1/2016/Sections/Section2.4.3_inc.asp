<table class="print-block" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<div align="center"><b>2.4.3. Сведения о классах, классах-комплектах</b></div>
			...
			<table class="ThinTable" align="left" border="1" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr align="middle" valign="center">
					...
					<td>01</td>
					<%=DrawInputsWithTotals(1, 3, 6, "02.4.3", Array(3,4,5,6))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
						&nbsp;&nbsp;в том числе:<br>
					...
					<td>02</td>
					<%=DrawInputsWithTotals(2, 3, 6, "02.4.3", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">&nbsp;&nbsp;5 - 9 классы</td>
					<td>03</td>
					<%=DrawInputsWithTotals(3, 3, 6, "02.4.3", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">&nbsp;&nbsp;10 - 11 (12) классы</td>
					<td>04</td>
					<%=DrawInputsWithTotals(4, 3, 6, "02.4.3", Array(3))%>
				</tr>
				<tr align="middle" valign="center">
					<td align="left">
					...
					<td>05</td>
					<%=DrawInputsWithTotals(5, 3, 5, "02.4.3", Array(3))%>
					<td>x</td>
				</tr>
			</table>
		</td>
