...
' Local deployment patch: ICOMDataAccess.IsRegionMoscowOrStPetersburg was removed from NS_DAComWrapper 5.14
' (error 438 "Object doesn't support this property or method"); federal cities have no provinces.
Function IsRegionMoscowOrStPetersburg(nStateID)
	Dim strStateName
	strStateName = LCase(objNSNET.GetStateName(GetSafeLng(nStateID, 0)))
	IsRegionMoscowOrStPetersburg = (strStateName = "москва" Or strStateName = "г. москва" Or strStateName = "санкт-петербург" Or strStateName = "г. санкт-петербург")
End Function
...
Sub onDrawPage()
	...
	<div class="row">
		<div class="col-md-12"><%
			...
			If Not IsRegionMoscowOrStPetersburg(nStateID) Then
				If bNoProvince Then
