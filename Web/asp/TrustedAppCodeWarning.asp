...
Function GetPageTitle()
	GetPageTitle = obLanguage("Login", "kTitleTrustedAppCodeWarning")
End Function
...
Sub onDrawPage()%>
	<div class="row">
		<div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
			<form name="TrustedAppCodeInfo" method="POST" ACTION="<%=nextPage%>">
				<%=WriteObligatoryTags()%>
				<%=WriteHiddenTags(Array("WorkPage", nextPage))%>
				<div class="row">
					<div class="col-md-12">
						<%DrawWarning Replace(obLanguage("Login", "kTextTrustedAppCodeWarning"), "%", NETSCHOOL_PRODUCT_NAME)%>
					</div>
				</div>
				<div class="row">
