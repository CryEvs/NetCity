...
Sub onDrawPage()
	Response.Write GetPageTitleExcel(obLanguage("Common","kSubjects"), Array(obLanguage("Common","kSchoolYear"), obTokenMgr.GetData(strToken, "CurrYearName"), obLanguage("Common","kView"), strView, strHCT, strCT ) )
	Call DrawTable()
