...
function charCodeAt_( s, pos ) {
	...
	else if (n>=1040 && n<=1103) return (n-848);
		else if (n==1025) return 168;
			else if (n==1105) return 184;
				else if (n==8470) return 185;
					else return 0;
}
/*
...
/* External interface */
function hexMD5_(str) { return binl2hex(coreMD5( str2binl_(str))) }
