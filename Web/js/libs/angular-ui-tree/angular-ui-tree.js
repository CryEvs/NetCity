      ...
      function ($scope, $element, $attrs, treeConfig) {
        ...
        $scope.init = function(controllersArr) {
          ...
          var mouseover = function (e) {
            $(e.currentTarget).addClass("tree-node-hover");
          };

          var mouseleave = function (e) {
            $(e.currentTarget).removeClass("tree-node-hover");
          };

          $scope.$element.bind('mouseover', mouseover);
          $scope.$element.bind('mouseleave', mouseleave);
